...
export interface SquareLinkedService {
  ...
  accessToken?: SecretBaseUnion;
  /**
   * The OAuth 2.0 refresh token associated with your Square application, used to refresh the
 ...
 */
export type FormatReadSettingsUnion = FormatReadSettings | JsonReadSettings | DelimitedTextReadSettings | BinaryReadSettings;
