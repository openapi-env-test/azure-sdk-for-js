...
export class MarketplaceOrderingAgreements extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    subscriptionId: string,
    options?: MarketplaceOrderingAgreementsOptionalParams
  ) {
    ...
    const defaults: MarketplaceOrderingAgreementsOptionalParams = {
      requestContentType: "application/json; charset=utf-8",
      credential: credentials
    };

    const packageDetails = `azsdk-js-arm-marketplaceordering/3.2.0`;
