...
export const AutopilotSettingsResource: msRest.CompositeMapper = {
  serializedName: "AutopilotSettingsResource",
  type: {
    name: "Composite",
    className: "AutopilotSettingsResource",
    modelProperties: {
      maxThroughput: {
        required: true,
...
export const ThroughputSettingsGetPropertiesResource: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      autopilotSettings: {
        serializedName: "autopilotSettings",
        type: {
          name: "Composite",
          className: "AutopilotSettingsResource"
        }
