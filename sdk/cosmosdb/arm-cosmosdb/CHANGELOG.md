...
**Features**
  ...
  - Type Alias DatabaseAccountCreateUpdateParameters has a new parameter keysMetadata
  ...
  - Type Alias DatabaseAccountGetResults has a new parameter keysMetadata
