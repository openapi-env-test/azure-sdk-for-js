...
**Features**
  ...
  - Added Type Alias PatchTrackedResource
  - Added Type Alias PatchVault
  - Added Type Alias ResourceCertificateAndAadDetails
  - Added Type Alias ResourceCertificateAndAcsDetails
  - Added Type Alias TrackedResource
  - Added Type Alias Vault
  - Added Type Alias VaultExtendedInfoResource
