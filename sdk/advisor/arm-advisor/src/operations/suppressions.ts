...
export class Suppressions {
   ...
   * @param callback The callback
   */
  create(resourceUri: string, recommendationId: string, name: string, suppressionContract: Models.SuppressionContract, callback: msRest.ServiceCallback<any>): void;
  /**
   * @param resourceUri The fully qualified Azure Resource Manager identifier of the resource to
   * which the recommendation applies.
   * @param recommendationId The recommendation ID.
   ...
   * @param callback The callback
   */
  create(resourceUri: string, recommendationId: string, name: string, suppressionContract: Models.SuppressionContract, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<any>): void;
  create(resourceUri: string, recommendationId: string, name: string, suppressionContract: Models.SuppressionContract, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<any>, callback?: msRest.ServiceCallback<any>): Promise<Models.SuppressionsCreateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceUri,
        recommendationId,
