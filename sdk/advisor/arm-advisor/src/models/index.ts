...
export interface DigestConfig {
  ...
  /**
   * Frequency that digest will be triggered. Value must conform to ISO 8601 standard and must be
   * greater than equal to 7 day and less than or equal to 30 days.
   */
  frequency?: Date;
  /**
