...
import { FoosImpl } from "./operations";
import { Foos } from "./operationsInterfaces";
import * as Parameters from "./models/parameters";
import * as Mappers from "./models/mappers";
import {
  ContosoOptionalParams,
  Operation,
...
export class Contoso extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    const defaults: ContosoOptionalParams = {
      requestContentType: "application/json; charset=utf-8",
      credential: credentials
    };

    const packageDetails = `azsdk-js-arm-contoso/1.0.0`;
    ...
    this.apiVersion = options.apiVersion || "2020-12-21";
