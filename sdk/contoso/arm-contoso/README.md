...
[API reference documentation](https://docs.microsoft.com/javascript/api/@azure/arm-contoso) |
...
### Create and authenticate a `Contoso`
...
const client = new Contoso(new DefaultAzureCredential(), subscriptionId);
...
// });
// const client = new Contoso(credential, subscriptionId);
```
...
`Contoso` is the primary interface for developers using the Azure Service client library. Explore the methods on this client object to understand the different features of the Azure Service service that you can access.
...
![Impressions](https://azure-sdk-impressions.azurewebsites.net/api/impressions/azure-sdk-for-js%2Fsdk%2Fcontoso%2Farm-contoso%2FREADME.png)
