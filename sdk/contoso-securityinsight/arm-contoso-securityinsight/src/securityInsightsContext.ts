...
const packageName = "@azure/arm-contoso-securityinsight";
const packageVersion = "1.0.0";

export class SecurityInsightsContext extends msRestAzure.AzureServiceClient {
  ...
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.SecurityInsightsOptions) {
    ...
    this.apiVersion = '2019-01-01-preview';
