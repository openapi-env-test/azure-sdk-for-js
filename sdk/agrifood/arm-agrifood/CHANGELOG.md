...
**Features**
  ...
  - Class AgriFoodMgmtClient has a new parameter solutionId
  - Class AgriFoodMgmtClient has a new parameter solutions
  - Class AgriFoodMgmtClient has a new parameter solutionsDiscoverability
