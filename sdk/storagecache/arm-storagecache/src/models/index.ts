...
export interface Cache {
  ...
  cacheSizeGB?: number;
  /** Multiplier that sets the current storage and throughput capacity of the cache. Values can be 1.0 (the base size, listed in the SKU), 1.33, 2.0, or 4.0. Values above 1.0 increase the cache size and throughput - for example, the scaling factor 1.33 gives a cache that's 33% larger than its base size. */
...
/** Known values of {@link ScalingFactor} that the service accepts. */
export enum KnownScalingFactor {
  One = 1,
  One33 = 1.33,
  Two = 2,
  Four = 4
 ...
 * {@link KnownScalingFactor} can be used interchangeably with ScalingFactor,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **1** \
 * **1.33** \
