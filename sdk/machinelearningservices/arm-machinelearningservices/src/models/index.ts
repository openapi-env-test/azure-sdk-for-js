...
export interface LinkedWorkspace {
  ...
  /**
   * SubscriptionId of the target of the linked workspace.
   */
  subscriptionId?: string;
  /**
   * Resource group name of the target of the linked workspace.
   */
  resourceGroupName?: string;
  /**
   * Resource provider namespace of the target of the linked workspace.
   */
  providerNamespace?: string;
  /**
   * Resource type of the target of the linked workspace.
   */
  resourceType?: string;
  /**
   * Resource name of the target of the linked workspace.
   */
  workspaceName?: string;
  /**
   * ResourceId of the target of the linked workspace.
   */
  resourceId?: string;
  /**
   * ResourceId of the user assigned identity that used to communicate with the linked workspace.
   */
...
export interface Workspace extends Resource {
  ...
  /**
   * Dictionary that contains all linked workspaces in the AML workspace, with resourceId of the
   * linked workspace as key.
   */
  linkedWorkspaces?: { [propertyName: string]: LinkedWorkspace };
}

/**
 * object used for creating linked workspace.
 */
export interface LinkedWorkspaceCreateDto {
  /**
   * Friendly name of the linked workspace
   */
  linkName?: string;
  /**
   * ResourceId of the linked workspace
   */
  resourceId?: string;
  /**
 ...
 */
export interface LinkedWorkspaceUpdateDto {
  /**
   * ResourceId of the user assigned identity for the linked workspace
   */
  userAssignedIdentityResourceId?: string;
 ...
 * Optional Parameters.
 */
export interface LinkedWorkspacesListOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 * Possible values include: 'SystemAssigned', 'SystemAssigned,UserAssigned'
 * @readonly
 * @enum {string}
 */
export type ResourceIdentityType = 'SystemAssigned' | 'SystemAssigned,UserAssigned';
 ...
 * Contains response data for the list operation.
 */
export type LinkedWorkspacesListResponse = Array<LinkedWorkspace> & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type LinkedWorkspacesCreateResponse = LinkedWorkspace & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the get operation.
 */
export type LinkedWorkspacesGetResponse = LinkedWorkspace & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the update operation.
 */
export type LinkedWorkspacesUpdateResponse = LinkedWorkspace & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
