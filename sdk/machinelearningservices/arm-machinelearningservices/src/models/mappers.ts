...
export const Workspace: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      linkedWorkspaces: {
        serializedName: "properties.linkedWorkspaces",
        type: {
          name: "Dictionary",
          value: {
            type: {
...
export const LinkedWorkspaceCreateDto: msRest.CompositeMapper = {
  serializedName: "LinkedWorkspaceCreateDto",
  type: {
    name: "Composite",
    className: "LinkedWorkspaceCreateDto",
    modelProperties: {
      linkName: {
        serializedName: "linkName",
        type: {
...
export const LinkedWorkspaceUpdateDto: msRest.CompositeMapper = {
  serializedName: "LinkedWorkspaceUpdateDto",
  type: {
    name: "Composite",
    className: "LinkedWorkspaceUpdateDto",
    modelProperties: {
      userAssignedIdentityResourceId: {
        serializedName: "userAssignedIdentityResourceId",
        type: {
