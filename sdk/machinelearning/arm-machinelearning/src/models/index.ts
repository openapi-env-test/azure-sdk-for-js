...
export interface EnvironmentVariable {
  /** Describes unknown properties. The value of an unknown property can be of "any" type. */
  [property: string]: any;
  /** Type of the Environment Variable. Possible values are: local - For local variable, azureml - For azureml variables */
...
export interface VolumeDefinition {
  ...
  /** Indicate whether to mount volume as read_only */
  readOnly?: boolean;
  /** Source of the mount */
  source?: string;
  /** Target of the mount */
