...
// @public (undocumented)
function createClient(endpoint: string, credentials: TokenCredential, options?: ClientOptions): PurviewAccountClient;

// @public (undocumented)
function createClient_2(Endpoint: string, credentials: TokenCredential, options?: ClientOptions): PurviewMetadataPoliciesClient;
