...
// @public (undocumented)
export function PurviewAccountClientClient(endpoint: string, credentials: TokenCredential, options?: ClientOptions): PurviewAccountClientRestClient;

// @public (undocumented)
type PurviewAccountClientRestClient = Client & {
    path: Routes;
};

declare namespace PurviewMetadataPoliciesClient {
    export {
        PurviewMetadataPoliciesClientClient,
...
// @public (undocumented)
export function PurviewMetadataPoliciesClientClient(Endpoint: string, credentials: TokenCredential, options?: ClientOptions): PurviewMetadataPoliciesClientRestClient;

// @public (undocumented)
type PurviewMetadataPoliciesClientRestClient = Client & {
    path: Routes_2;
};
