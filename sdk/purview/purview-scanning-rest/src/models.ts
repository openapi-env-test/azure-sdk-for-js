...
export interface AzureKeyVaultProperties
  extends AzureKeyVaultPropertiesAutoGenerated {}
...
export interface RegexClassificationRulePattern
  extends ClassificationRulePatternBase {
  pattern?: string;
  kind: "Regex";
}
...
export interface AzureSubscriptionDataSourceProperties
  extends AzureSubscriptionProperties {}
...
export interface AzureResourceGroupDataSourceProperties
  extends AzureResourceGroupProperties {}
...
export interface AzureSynapseWorkspaceProperties
  extends AzureDataSourceProperties {
...
export interface AzureSynapseDataSourceProperties
  extends AzureSynapseProperties {}
...
export interface AmazonAccountDataSourceProperties
  extends AmazonAccountProperties {}
...
export interface AzureCosmosDbDataSourceProperties
  extends AzureCosmosDbProperties {}
...
export interface AzureDataExplorerDataSourceProperties
  extends AzureDataExplorerProperties {}
...
export interface AzureFileServiceDataSourceProperties
...
export interface AzureSqlDatabaseDataSourceProperties
  extends AzureSqlDatabaseProperties {}
...
export interface AmazonPostgreSqlDataSourceProperties
  extends AmazonPostgreSqlProperties {}
...
export interface AzurePostgreSqlDataSourceProperties
...
export interface SqlServerDatabaseDataSourceProperties
  extends SqlServerDatabaseProperties {}

export interface AzureSqlDatabaseManagedInstanceProperties
  extends AzureDataSourceProperties {
  serverEndpoint?: string;
}

export interface AzureSqlDatabaseManagedInstanceDataSource
...
export interface AzureSqlDataWarehouseProperties
  extends AzureDataSourceProperties {
  serverEndpoint?: string;
}
...
export interface AzureStorageDataSourceProperties
...
export interface AzureSubscriptionScanRulesetProperties
...
export interface AzureResourceGroupScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AzureSynapseWorkspaceScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AzureSynapseScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface ScanningRuleScanRulesetPropertiesScanningRule
  extends ScanningRule {}

export interface AdlsGen1ScanRulesetProperties
  extends ScanningRuleScanRulesetProperties {}
...
export interface AdlsGen1ScanRulesetPropertiesAutoGenerated
  extends AdlsGen1ScanRulesetProperties {}

export interface AdlsGen2ScanRulesetProperties
  extends ScanningRuleScanRulesetProperties {}
...
export interface AdlsGen2ScanRulesetPropertiesAutoGenerated
  extends AdlsGen2ScanRulesetProperties {}

export interface AmazonAccountScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AmazonS3ScanRulesetProperties
  extends ScanningRuleScanRulesetProperties {}
...
export interface AmazonS3ScanRulesetPropertiesAutoGenerated
  extends AmazonS3ScanRulesetProperties {}
...
export interface AzureCosmosDbScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AzureDataExplorerScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AzureFileServiceScanRulesetProperties
  extends ScanningRuleScanRulesetProperties {}
...
export interface AzureSqlDatabaseScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AmazonPostgreSqlScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface SqlServerDatabaseScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AzureSqlDatabaseManagedInstanceScanRuleset
  extends ScanRulesetBase {
...
export interface AzureSqlDataWarehouseScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AzureMySqlScanRulesetProperties
  extends ScanRulesetProperties {}
...
export interface AzureStorageScanRulesetProperties
  extends ScanningRuleScanRulesetProperties {}
...
export interface TeradataScanRulesetPropertiesAutoGenerated
...
export interface OracleScanRulesetPropertiesAutoGenerated
  extends OracleScanRulesetProperties {}
...
export interface SapEccScanRulesetPropertiesAutoGenerated
  extends SapEccScanRulesetProperties {}
...
export interface PowerBIScanRulesetPropertiesAutoGenerated
...
export interface ResourceTypeFilterResourceNameFilter
  extends ResourceNameFilter {}
...
export interface ExpandingResourceScanPropertiesCredential
...
export interface AzureSubscriptionMsiScanProperties
  extends ExpandingResourceScanProperties {}
...
export interface AzureResourceGroupMsiScanProperties
  extends ExpandingResourceScanProperties {}
...
export interface AzureSynapseWorkspaceMsiScanProperties
  extends ExpandingResourceScanProperties {}
...
export interface AzureSynapseMsiScanProperties
  extends ExpandingResourceScanProperties {}
...
export interface AzureSynapseMsiScanPropertiesAutoGenerated
  extends AzureSynapseMsiScanProperties {}
...
export interface AdlsGen1CredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AdlsGen1MsiScanPropertiesAutoGenerated
  extends AdlsGen1MsiScanProperties {}
...
export interface AdlsGen2CredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AdlsGen2MsiScanPropertiesAutoGenerated
  extends AdlsGen2MsiScanProperties {}

export interface AmazonAccountCredentialScanProperties
  extends ExpandingResourceScanProperties {}
...
export interface AmazonS3CredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AmazonS3RoleARNScanPropertiesAutoGenerated
  extends AmazonS3RoleARNScanProperties {}
...
export interface AmazonSqlCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AzureCosmosDbCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AzureDataExplorerCredentialScanProperties
  extends ScanProperties {
  credential?: AzureDataExplorerCredentialScanPropertiesCredential;
  database?: string;
}

export interface AzureDataExplorerCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AzureFileServiceCredentialScanProperties
  extends ScanProperties {
  credential?: AzureFileServiceCredentialScanPropertiesCredential;
  shareName?: string;
}

export interface AzureFileServiceCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AzureSqlCredentialScanProperties
  extends AzureSqlScanProperties {
  credential?: AzureSqlCredentialScanPropertiesCredential;
}

export interface AzureSqlCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AzureSqlDatabaseMsiScanProperties
  extends AzureSqlScanProperties {}
...
export interface AmazonPostgreSqlCredentialScanProperties
  extends ScanProperties {
...
export interface AzureSqlDatabaseManagedInstanceCredentialScan
  extends ScanBase {
...
export interface AzureSqlDatabaseManagedInstanceMsiScanProperties
  extends AzureSqlScanProperties {}
...
export interface AzureSqlDataWarehouseMsiScanProperties
  extends AzureSqlScanProperties {}
...
export interface AzureMySqlScanPropertiesCredential
  extends CredentialReference {}

export interface AzureMySqlCredentialScanProperties
  extends AzureMySqlScanProperties {}
...
export interface AzureStorageCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface AzureStorageMsiScanPropertiesAutoGenerated
  extends AzureStorageMsiScanProperties {}
...
export interface TeradataCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface TeradataTeradataUserPassScanProperties
  extends MitiScanProperties {
  username?: string;
  password?: string;
  schema?: string;
  driverLocation?: string;
...
export interface OracleCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface OracleOracleCredentialScanProperties
...
export interface OracleOracleUserPassScanProperties
  extends OracleUserPassScanProperties {}

export interface SapS4HanaSapS4HanaCredentialScanProperties
  extends MitiScanProperties {
  clientId?: string;
...
export interface SapS4HanaSapS4HanaUserPassScanProperties
  extends MitiScanProperties {
  clientId?: string;
  username?: string;
  password?: string;
...
export interface SapEccCredentialScanPropertiesCredential
  extends CredentialReference {}
...
export interface SapEccSapEccCredentialScanProperties
...
export interface SapEccSapEccUserPassScanProperties
  extends SapEccUserPassScanProperties {}
...
export interface PowerBIMsiScanPropertiesAutoGenerated
  extends PowerBIMsiScanProperties {}

export interface AzureSubscriptionSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AzureSynapseWorkspaceSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AdlsGen1SystemScanRulesetProperties
  extends AdlsGen1ScanRulesetProperties {}
...
export interface AdlsGen2SystemScanRulesetProperties
  extends AdlsGen2ScanRulesetProperties {}
...
export interface AmazonS3SystemScanRulesetProperties
  extends AmazonS3ScanRulesetProperties {}
...
export interface AmazonSqlSystemScanRulesetProperties
  extends AmazonSqlScanRulesetProperties {}
...
export interface AzureDataExplorerSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AzureFileServiceSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AzureSqlDatabaseSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AmazonPostgreSqlSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AzurePostgreSqlSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface SqlServerDatabaseSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AzureSqlDatabaseManagedInstanceSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AzureSqlDataWarehouseSystemScanRuleset
  extends SystemScanRulesetBase {
...
export interface AzureMySqlSystemScanRulesetProperties
  extends AzureMySqlScanRulesetProperties {}
...
export interface TeradataSystemScanRulesetProperties
  extends TeradataScanRulesetProperties {}
...
export interface OracleSystemScanRulesetProperties
  extends OracleScanRulesetProperties {}
...
export interface SapS4HanaSystemScanRulesetProperties
  extends SapS4HanaScanRulesetProperties {}
...
export interface SapEccSystemScanRulesetProperties
  extends SapEccScanRulesetProperties {}
...
export interface PowerBISystemScanRulesetProperties
  extends PowerBIScanRulesetProperties {}
