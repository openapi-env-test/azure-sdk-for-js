...
export class AppServicePlans {
   ...
   */
  listMetricsNext(nextPageLink: string, options?: Models.AppServicePlansListMetricsNextOptionalParams): Promise<Models.AppServicePlansListMetricsNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listMetricsNext(nextPageLink: string, options: Models.AppServicePlansListMetricsNextOptionalParams, callback: msRest.ServiceCallback<Models.ResourceMetricCollection>): void;
  listMetricsNext(nextPageLink: string, options?: Models.AppServicePlansListMetricsNextOptionalParams | msRest.ServiceCallback<Models.ResourceMetricCollection>, callback?: msRest.ServiceCallback<Models.ResourceMetricCollection>): Promise<Models.AppServicePlansListMetricsNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
