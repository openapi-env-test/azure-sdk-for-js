...
#### nodejs - client creation and getCertificate certificateOrders as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  const certificateOrderName = "testcertificateOrderName";
  const name = "testname";
  client.certificateOrders.getCertificate(resourceGroupName, certificateOrderName, name).then((result) => {
...
#### browser - Authentication, client creation and getCertificate certificateOrders as an example written in JavaScript.
