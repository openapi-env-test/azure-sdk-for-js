...
#### nodejs - client creation and list domains as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.domains.list().then((result) => {
...
#### browser - Authentication, client creation and list domains as an example written in JavaScript.
