...
#### nodejs - client creation and list webApps as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.webApps.list().then((result) => {
...
#### browser - Authentication, client creation and list webApps as an example written in JavaScript.
