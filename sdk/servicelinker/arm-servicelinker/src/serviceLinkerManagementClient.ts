...
import {
  ...
  LinkersImpl,
  OperationsImpl,
  ConfigurationNamesOperationsImpl
} from "./operations";
import {
  Connector,
  Linker,
...
export class ServiceLinkerManagementClient extends coreClient.ServiceClient {
  ...
  constructor(
    ...
    const packageDetails = `azsdk-js-arm-servicelinker/2.1.0-beta.1`;
    ...
    this.configurationNamesOperations = new ConfigurationNamesOperationsImpl(
      this
    );
