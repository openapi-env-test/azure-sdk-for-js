...
// @public
export type AccessReviewDecisionUserSignInInsightProperties = AccessReviewDecisionInsightProperties & {
    type: "userSignInInsight";
...
export interface AccessReviewDefaultSettingsOperations {
    get(subscriptionId: string, options?: AccessReviewDefaultSettingsGetOptionalParams): Promise<AccessReviewDefaultSettingsGetResponse>;
    put(subscriptionId: string, properties: AccessReviewScheduleSettings, options?: AccessReviewDefaultSettingsPutOptionalParams): Promise<AccessReviewDefaultSettingsPutResponse>;
}
...
export interface AccessReviewHistoryDefinitionInstance {
    generateDownloadUri(subscriptionId: string, historyDefinitionId: string, instanceId: string, options?: AccessReviewHistoryDefinitionInstanceGenerateDownloadUriOptionalParams): Promise<AccessReviewHistoryDefinitionInstanceGenerateDownloadUriResponse>;
}
...
export interface AccessReviewHistoryDefinitionInstances {
    list(subscriptionId: string, historyDefinitionId: string, options?: AccessReviewHistoryDefinitionInstancesListOptionalParams): PagedAsyncIterableIterator<AccessReviewHistoryInstance>;
}
...
export interface AccessReviewHistoryDefinitionOperations {
    create(subscriptionId: string, historyDefinitionId: string, properties: AccessReviewHistoryDefinitionProperties, options?: AccessReviewHistoryDefinitionCreateOptionalParams): Promise<AccessReviewHistoryDefinitionCreateResponse>;
    deleteById(subscriptionId: string, historyDefinitionId: string, options?: AccessReviewHistoryDefinitionDeleteByIdOptionalParams): Promise<void>;
}
...
export interface AccessReviewHistoryDefinitions {
    getById(subscriptionId: string, historyDefinitionId: string, options?: AccessReviewHistoryDefinitionsGetByIdOptionalParams): Promise<AccessReviewHistoryDefinitionsGetByIdResponse>;
    list(subscriptionId: string, options?: AccessReviewHistoryDefinitionsListOptionalParams): PagedAsyncIterableIterator<AccessReviewHistoryDefinition>;
}
...
export interface AccessReviewInstanceContactedReviewers {
    list(subscriptionId: string, scheduleDefinitionId: string, id: string, options?: AccessReviewInstanceContactedReviewersListOptionalParams): PagedAsyncIterableIterator<AccessReviewContactedReviewer>;
}
...
export interface AccessReviewInstanceDecisions {
    list(subscriptionId: string, scheduleDefinitionId: string, id: string, options?: AccessReviewInstanceDecisionsListOptionalParams): PagedAsyncIterableIterator<AccessReviewDecision>;
}
...
export interface AccessReviewInstanceOperations {
    ...
    applyDecisions(subscriptionId: string, scheduleDefinitionId: string, id: string, options?: AccessReviewInstanceApplyDecisionsOptionalParams): Promise<void>;
    resetDecisions(subscriptionId: string, scheduleDefinitionId: string, id: string, options?: AccessReviewInstanceResetDecisionsOptionalParams): Promise<void>;
    sendReminders(subscriptionId: string, scheduleDefinitionId: string, id: string, options?: AccessReviewInstanceSendRemindersOptionalParams): Promise<void>;
    stop(subscriptionId: string, scheduleDefinitionId: string, id: string, options?: AccessReviewInstanceStopOptionalParams): Promise<void>;
}
...
export interface AccessReviewInstances {
    create(subscriptionId: string, scheduleDefinitionId: string, id: string, properties: AccessReviewInstanceProperties, options?: AccessReviewInstancesCreateOptionalParams): Promise<AccessReviewInstancesCreateResponse>;
    getById(subscriptionId: string, scheduleDefinitionId: string, id: string, options?: AccessReviewInstancesGetByIdOptionalParams): Promise<AccessReviewInstancesGetByIdResponse>;
    list(subscriptionId: string, scheduleDefinitionId: string, options?: AccessReviewInstancesListOptionalParams): PagedAsyncIterableIterator<AccessReviewInstance>;
}
...
export interface AccessReviewScheduleDefinitions {
    createOrUpdateById(subscriptionId: string, scheduleDefinitionId: string, properties: AccessReviewScheduleDefinitionProperties, options?: AccessReviewScheduleDefinitionsCreateOrUpdateByIdOptionalParams): Promise<AccessReviewScheduleDefinitionsCreateOrUpdateByIdResponse>;
    deleteById(subscriptionId: string, scheduleDefinitionId: string, options?: AccessReviewScheduleDefinitionsDeleteByIdOptionalParams): Promise<void>;
    getById(subscriptionId: string, scheduleDefinitionId: string, options?: AccessReviewScheduleDefinitionsGetByIdOptionalParams): Promise<AccessReviewScheduleDefinitionsGetByIdResponse>;
    list(subscriptionId: string, options?: AccessReviewScheduleDefinitionsListOptionalParams): PagedAsyncIterableIterator<AccessReviewScheduleDefinition>;
    stop(subscriptionId: string, scheduleDefinitionId: string, options?: AccessReviewScheduleDefinitionsStopOptionalParams): Promise<void>;
}
