...
export class AccessReviewInstancesImpl implements AccessReviewInstances {
  ...
  getById(
    ...
    return this.client.sendOperationRequest(
      { subscriptionId, scheduleDefinitionId, id, options },
  ...
  create(
    ...
    return this.client.sendOperationRequest(
      { subscriptionId, scheduleDefinitionId, id, properties, options },
      createOperationSpec
    );
  }
  ...
  private _listNext(
    ...
    return this.client.sendOperationRequest(
      { subscriptionId, scheduleDefinitionId, nextLink, options },
