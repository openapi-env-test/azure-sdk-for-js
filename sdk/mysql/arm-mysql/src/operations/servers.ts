...
export class Servers {
   ...
   * @returns Promise<msRest.RestResponse>
   */
  test(resourceGroupName: string, serverName: string, options?: msRest.RequestOptionsBase): Promise<msRest.RestResponse> {
    return this.beginTest(resourceGroupName,serverName,options)
      .then(lroPoller => lroPoller.pollUntilFinished());
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginTest(resourceGroupName: string, serverName: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        resourceGroupName,
        serverName,
