 ...
 */
export interface FirewallPolicyIntrusionSystemRuleCategories {
  /**
   * Rule category name.
   */
  categoryName?: string;
  /**
   * The category state. Possible values include: 'Off', 'Alert', 'Deny'
   */
 ...
 */
export interface FirewallPolicyIntrusionSystemRulesSpecifications {
  /**
   * Rule id (sid).
   */
  ruleId?: string;
...
export interface FirewallPolicyIntrusionSystemConfiguration {
  /**
   * List of rules categories states.
   */
  ruleCategories?: FirewallPolicyIntrusionSystemRuleCategories[];
  /**
   * List of specific rules states.
   */
  rules?: FirewallPolicyIntrusionSystemRulesSpecifications[];
}
...
export interface FirewallPolicy extends Resource {
   ...
   */
  intrusionSystemConfiguration?: FirewallPolicyIntrusionSystemConfiguration;
  /**
