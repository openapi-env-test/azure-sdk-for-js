...
export interface InboundNatRule extends SubResource {
   ...
   * the frontend port of each of the frontend IP configurations is forwarded to the backed IP.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface SecurityRule extends SubResource {
  ...
  /**
   * The destination address prefix. CIDR or source IP range. Asterisk '*' can also be used to
