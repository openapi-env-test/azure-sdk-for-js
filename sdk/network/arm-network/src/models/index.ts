...
export interface FirewallPolicyNatRuleCollection {
  ...
  /**
   * The translated address for this NAT rule collection.
   */
  translatedAddress?: string;
  /**
   * The translated port for this NAT rule collection.
   */
  translatedPort?: string;
  /**
   * The match rule for incoming traffic.
   */
  rule?: FirewallPolicyRuleUnion;
}
