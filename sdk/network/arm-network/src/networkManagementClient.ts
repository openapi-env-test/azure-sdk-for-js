...
class NetworkManagementClient extends NetworkManagementClientContext {
  ...
  connectivityConfigurations: operations.ConnectivityConfigurations;
  securityConfigurations: operations.SecurityConfigurations;
  securityConfigurationRules: operations.SecurityConfigurationRules;
  commits: operations.Commits;
  networkGroups: operations.NetworkGroups;
  activeConfigurations: operations.ActiveConfigurations;
  networkManagers: operations.NetworkManagers;
  ...
  constructor(credentials: msRest.ServiceClientCredentials, subscriptionId: string, options?: Models.NetworkManagementClientOptions) {
    ...
    this.connectivityConfigurations = new operations.ConnectivityConfigurations(this);
    this.securityConfigurations = new operations.SecurityConfigurations(this);
    this.securityConfigurationRules = new operations.SecurityConfigurationRules(this);
    this.commits = new operations.Commits(this);
    this.networkGroups = new operations.NetworkGroups(this);
    this.activeConfigurations = new operations.ActiveConfigurations(this);
    this.networkManagers = new operations.NetworkManagers(this);
