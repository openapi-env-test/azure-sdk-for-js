...
export class TestJobStreams {
   ...
   */
  listByTestJobNext(nextPageLink: string, options?: Models.TestJobStreamsListByTestJobNextOptionalParams): Promise<Models.TestJobStreamsListByTestJobNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByTestJobNext(nextPageLink: string, options: Models.TestJobStreamsListByTestJobNextOptionalParams, callback: msRest.ServiceCallback<Models.JobStreamListResult>): void;
  listByTestJobNext(nextPageLink: string, options?: Models.TestJobStreamsListByTestJobNextOptionalParams | msRest.ServiceCallback<Models.JobStreamListResult>, callback?: msRest.ServiceCallback<Models.JobStreamListResult>): Promise<Models.TestJobStreamsListByTestJobNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
