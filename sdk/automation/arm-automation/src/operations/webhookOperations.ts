...
export class WebhookOperations {
   ...
   */
  listByAutomationAccountNext(nextPageLink: string, options?: Models.WebhookListByAutomationAccountNextOptionalParams): Promise<Models.WebhookListByAutomationAccountNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByAutomationAccountNext(nextPageLink: string, options: Models.WebhookListByAutomationAccountNextOptionalParams, callback: msRest.ServiceCallback<Models.WebhookListResult>): void;
  listByAutomationAccountNext(nextPageLink: string, options?: Models.WebhookListByAutomationAccountNextOptionalParams | msRest.ServiceCallback<Models.WebhookListResult>, callback?: msRest.ServiceCallback<Models.WebhookListResult>): Promise<Models.WebhookListByAutomationAccountNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
