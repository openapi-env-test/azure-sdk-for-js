...
export class Clusters {
   ...
   * @returns Promise<Models.ClustersListAvailableClustersResponse>
   */
  listAvailableClusters(options?: msRest.RequestOptionsBase): Promise<Models.ClustersListAvailableClustersResponse>;
  /**
   * @param callback The callback
   */
  listAvailableClusters(callback: msRest.ServiceCallback<Models.AvailableClustersList>): void;
  /**
   * @param options The optional parameters
   * @param callback The callback
   */
  listAvailableClusters(options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.AvailableClustersList>): void;
  listAvailableClusters(options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.AvailableClustersList>, callback?: msRest.ServiceCallback<Models.AvailableClustersList>): Promise<Models.ClustersListAvailableClustersResponse> {
    return this.client.sendOperationRequest(
      {
        options
      },
      listAvailableClustersOperationSpec,
      callback) as Promise<Models.ClustersListAvailableClustersResponse>;
  }
   ...
   * @param clusterName The name of the Event Hubs Cluster.
   * @param [options] The optional parameters
   * @returns Promise<Models.ClustersPutResponse>
   */
  put(resourceGroupName: string, clusterName: string, options?: msRest.RequestOptionsBase): Promise<Models.ClustersPutResponse> {
    return this.beginPut(resourceGroupName,clusterName,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.ClustersPutResponse>;
  }
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.ClustersPatchResponse>
   */
  patch(resourceGroupName: string, clusterName: string, parameters: Models.Cluster, options?: msRest.RequestOptionsBase): Promise<Models.ClustersPatchResponse> {
    return this.beginPatch(resourceGroupName,clusterName,parameters,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.ClustersPatchResponse>;
  }
   ...
   */
  beginPut(resourceGroupName: string, clusterName: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginPatch(resourceGroupName: string, clusterName: string, parameters: Models.Cluster, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        resourceGroupName,
        clusterName,
...
const listAvailableClustersOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
