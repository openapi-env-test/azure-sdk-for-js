...
#### nodejs - client creation and list profilesTest as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.profilesTest.list().then((result) => {
...
#### browser - Authentication, client creation and list profilesTest as an example written in JavaScript.
