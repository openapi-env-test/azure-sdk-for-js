...
#### nodejs - client creation and listXXX profiles as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.profiles.listXXX().then((result) => {
...
#### browser - Authentication, client creation and listXXX profiles as an example written in JavaScript.
