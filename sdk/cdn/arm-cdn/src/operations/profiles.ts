...
export class Profiles {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.ProfilesGetXXXResponse>
   */
  getXXX(resourceGroupName: string, profileName: string, options?: msRest.RequestOptionsBase): Promise<Models.ProfilesGetXXXResponse>;
  /**
   * @param resourceGroupName Name of the Resource group within the Azure subscription.
   * @param profileName Name of the CDN profile which is unique within the resource group.
   * @param callback The callback
   */
  getXXX(resourceGroupName: string, profileName: string, callback: msRest.ServiceCallback<Models.Profile>): void;
  /**
   * @param resourceGroupName Name of the Resource group within the Azure subscription.
   * @param profileName Name of the CDN profile which is unique within the resource group.
   * @param options The optional parameters
   * @param callback The callback
   */
  getXXX(resourceGroupName: string, profileName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.Profile>): void;
  getXXX(resourceGroupName: string, profileName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.Profile>, callback?: msRest.ServiceCallback<Models.Profile>): Promise<Models.ProfilesGetXXXResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
      ...
      getXXXOperationSpec,
      callback) as Promise<Models.ProfilesGetXXXResponse>;
  }
   ...
   */
  create(resourceGroupName: string, profile: Models.Profile, options?: msRest.RequestOptionsBase): Promise<Models.ProfilesCreateResponse> {
    return this.beginCreate(resourceGroupName,profile,options)
   ...
   */
  beginCreate(resourceGroupName: string, profile: Models.Profile, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
...
const getXXXOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
