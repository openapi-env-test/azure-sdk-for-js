...
export class Profiles {
   ...
   * @param profileName Name of the CDN profile which is unique within the resource group.
   * @param [options] The optional parameters
   * @returns Promise<Models.ProfilesGenerateSsoUriXResponse>
   */
  generateSsoUriX(resourceGroupName: string, profileName: string, options?: msRest.RequestOptionsBase): Promise<Models.ProfilesGenerateSsoUriXResponse>;
  /**
   * @param resourceGroupName Name of the Resource group within the Azure subscription.
   * @param profileName Name of the CDN profile which is unique within the resource group.
   * @param callback The callback
   */
  generateSsoUriX(resourceGroupName: string, profileName: string, callback: msRest.ServiceCallback<Models.SsoUri>): void;
  /**
   * @param resourceGroupName Name of the Resource group within the Azure subscription.
   * @param profileName Name of the CDN profile which is unique within the resource group.
   * @param options The optional parameters
   * @param callback The callback
   */
  generateSsoUriX(resourceGroupName: string, profileName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SsoUri>): void;
  generateSsoUriX(resourceGroupName: string, profileName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SsoUri>, callback?: msRest.ServiceCallback<Models.SsoUri>): Promise<Models.ProfilesGenerateSsoUriXResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
      ...
      generateSsoUriXOperationSpec,
      callback) as Promise<Models.ProfilesGenerateSsoUriXResponse>;
  }
...
const generateSsoUriXOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
