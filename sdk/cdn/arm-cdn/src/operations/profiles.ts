...
export class Profiles {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.ProfilesGetXResponse>
   */
  getX(resourceGroupName: string, profileName: string, options?: msRest.RequestOptionsBase): Promise<Models.ProfilesGetXResponse>;
  /**
   * @param resourceGroupName Name of the Resource group within the Azure subscription.
   * @param profileName Name of the CDN profile which is unique within the resource group.
   * @param callback The callback
   */
  getX(resourceGroupName: string, profileName: string, callback: msRest.ServiceCallback<Models.Profile>): void;
  /**
   * @param resourceGroupName Name of the Resource group within the Azure subscription.
   * @param profileName Name of the CDN profile which is unique within the resource group.
   * @param options The optional parameters
   * @param callback The callback
   */
  getX(resourceGroupName: string, profileName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.Profile>): void;
  getX(resourceGroupName: string, profileName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.Profile>, callback?: msRest.ServiceCallback<Models.Profile>): Promise<Models.ProfilesGetXResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        profileName,
      ...
      getXOperationSpec,
      callback) as Promise<Models.ProfilesGetXResponse>;
  }
...
const getXOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
