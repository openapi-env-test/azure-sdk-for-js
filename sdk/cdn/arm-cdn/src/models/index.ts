 ...
 * Optional Parameters.
 */
export interface SecurityPoliciesPatchOptionalParams extends msRest.RequestOptionsBase {
  /**
   * object which contains security policy parameters
   */
  parameters?: SecurityPolicyParametersUnion;
 ...
 * Optional Parameters.
 */
export interface SecurityPoliciesBeginPatchOptionalParams extends msRest.RequestOptionsBase {
  /**
   * object which contains security policy parameters
   */
  parameters?: SecurityPolicyParametersUnion;
 ...
 * Possible values include: 'IgnoreQueryString', 'UseQueryString', 'NotSet'
 * @readonly
 * @enum {string}
 */
 ...
 * Possible values include: 'clientRequestCount', 'clientRequestTraffic', 'clientRequestBandwidth',
 * 'originRequestTraffic', 'originRequestBandwidth', 'totalLatency'
 * @readonly
 * @enum {string}
 */
export type LogMetric = 'clientRequestCount' | 'clientRequestTraffic' | 'clientRequestBandwidth' | 'originRequestTraffic' | 'originRequestBandwidth' | 'totalLatency';
 ...
 * @enum {string}
 */
export type LogMetricsGranularity = 'PT5M' | 'PT1H' | 'P1D';

/**
 * Defines values for LogMetricsGroupBy.
 * Possible values include: 'httpStatusCode', 'protocol', 'cacheStatus', 'country', 'customDomain'
 * @readonly
 * @enum {string}
 */
export type LogMetricsGroupBy = 'httpStatusCode' | 'protocol' | 'cacheStatus' | 'country' | 'customDomain';

/**
 * Defines values for LogRanking.
 * Possible values include: 'url', 'referrer', 'browser', 'userAgent', 'countryOrRegion'
 * @readonly
 * @enum {string}
 */
export type LogRanking = 'url' | 'referrer' | 'browser' | 'userAgent' | 'countryOrRegion';

/**
 * Defines values for LogRankingMetric.
 * Possible values include: 'clientRequestCount', 'clientRequestTraffic', 'hitCount', 'missCount',
 * 'userErrorCount', 'errorCount'
 * @readonly
 * @enum {string}
 */
export type LogRankingMetric = 'clientRequestCount' | 'clientRequestTraffic' | 'hitCount' | 'missCount' | 'userErrorCount' | 'errorCount';

/**
 * Defines values for WafMetric.
 * Possible values include: 'clientRequestCount'
 * @readonly
 * @enum {string}
 */
export type WafMetric = 'clientRequestCount';
 ...
 * @enum {string}
 */
export type WafGranularity = 'PT5M' | 'PT1H' | 'P1D';
 ...
 * @enum {string}
 */
export type WafAction = 'allow' | 'block' | 'log' | 'redirect';

/**
 * Defines values for WafRankingGroupBy.
 * Possible values include: 'httpStatusCode', 'customDomain'
 * @readonly
 * @enum {string}
 */
export type WafRankingGroupBy = 'httpStatusCode' | 'customDomain';

/**
 * Defines values for WafRuleType.
 * Possible values include: 'managed', 'custom', 'bot'
 * @readonly
 * @enum {string}
 */
export type WafRuleType = 'managed' | 'custom' | 'bot';

/**
 * Defines values for WafRankingType.
 * Possible values include: 'action', 'ruleGroup', 'ruleId', 'userAgent', 'clientIp', 'url',
 * 'country', 'ruleType'
 * @readonly
 * @enum {string}
 */
export type WafRankingType = 'action' | 'ruleGroup' | 'ruleId' | 'userAgent' | 'clientIp' | 'url' | 'country' | 'ruleType';
