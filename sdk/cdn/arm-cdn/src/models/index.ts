...
/**
 * Contains response data for the listXXX operation.
 */
export type ProfilesListXXXResponse = ProfileListResult & {
  /**
...
/**
 * Contains response data for the listXXXNext operation.
 */
export type ProfilesListXXXNextResponse = ProfileListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
