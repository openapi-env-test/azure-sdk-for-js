...
**Features**
  ...
  - Interface UsageDetailsListNextOptionalParams has a new optional parameter endDate
  - Interface UsageDetailsListNextOptionalParams has a new optional parameter startDate
  - Interface UsageDetailsListOptionalParams has a new optional parameter endDate
  - Interface UsageDetailsListOptionalParams has a new optional parameter startDate
