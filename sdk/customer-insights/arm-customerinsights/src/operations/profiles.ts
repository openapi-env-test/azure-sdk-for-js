...
export class Profiles {
   ...
   */
  listByHubNext(nextPageLink: string, options?: Models.ProfilesListByHubNextOptionalParams): Promise<Models.ProfilesListByHubNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByHubNext(nextPageLink: string, options: Models.ProfilesListByHubNextOptionalParams, callback: msRest.ServiceCallback<Models.ProfileListResult>): void;
  listByHubNext(nextPageLink: string, options?: Models.ProfilesListByHubNextOptionalParams | msRest.ServiceCallback<Models.ProfileListResult>, callback?: msRest.ServiceCallback<Models.ProfileListResult>): Promise<Models.ProfilesListByHubNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
