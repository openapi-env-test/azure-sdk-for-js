...
export class Interactions {
   ...
   */
  listByHubNext(nextPageLink: string, options?: Models.InteractionsListByHubNextOptionalParams): Promise<Models.InteractionsListByHubNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByHubNext(nextPageLink: string, options: Models.InteractionsListByHubNextOptionalParams, callback: msRest.ServiceCallback<Models.InteractionListResult>): void;
  listByHubNext(nextPageLink: string, options?: Models.InteractionsListByHubNextOptionalParams | msRest.ServiceCallback<Models.InteractionListResult>, callback?: msRest.ServiceCallback<Models.InteractionListResult>): Promise<Models.InteractionsListByHubNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
