...
export class Views {
   ...
   */
  listByHubNext(nextPageLink: string, userId: string, options?: msRest.RequestOptionsBase): Promise<Models.ViewsListByHubNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param userId The user ID. Use * to retrieve hub level views.
   * @param callback The callback
   */
  listByHubNext(nextPageLink: string, userId: string, callback: msRest.ServiceCallback<Models.ViewListResult>): void;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param userId The user ID. Use * to retrieve hub level views.
   * @param options The optional parameters
   * @param callback The callback
   */
  listByHubNext(nextPageLink: string, userId: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ViewListResult>): void;
  listByHubNext(nextPageLink: string, userId: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ViewListResult>, callback?: msRest.ServiceCallback<Models.ViewListResult>): Promise<Models.ViewsListByHubNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        userId,
