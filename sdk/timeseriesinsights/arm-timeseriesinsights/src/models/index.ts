 ...
 * @extends Array<EnvironmentResourceUnion>
 */
export interface EnvironmentListResponse extends Array<EnvironmentResourceUnion> {
}

/**
 * @interface
 * The response of the List EventSources operation.
 * @extends Array<EventSourceResourceUnion>
 */
export interface EventSourceListResponse extends Array<EventSourceResourceUnion> {
}

/**
 * @interface
 * The response of the List Reference Data Sets operation.
 * @extends Array<ReferenceDataSetResource>
 */
export interface ReferenceDataSetListResponse extends Array<ReferenceDataSetResource> {
}

/**
 * @interface
 * The response of the List access policies operation.
 * @extends Array<AccessPolicyResource>
 */
export interface AccessPolicyListResponse extends Array<AccessPolicyResource> {
}
