## An isomorphic javascript sdk for - BatchTextTranslationAPI
...
#### nodejs - Authentication, client creation and getDocumentStatus  as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  const documentId = 1;
  client.getDocumentStatus(documentId).then((result) => {
...
#### browser - Authentication, client creation and getDocumentStatus  as an example written in JavaScript.
