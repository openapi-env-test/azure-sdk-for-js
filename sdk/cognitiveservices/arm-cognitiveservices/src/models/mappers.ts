...
export const CognitiveServicesAccountSkuChangeInfo: msRest.CompositeMapper = {
  serializedName: "CognitiveServicesAccountSkuChangeInfo",
  type: {
    name: "Composite",
    className: "CognitiveServicesAccountSkuChangeInfo",
    modelProperties: {
      countOfDowngrades: {
        readOnly: true,
