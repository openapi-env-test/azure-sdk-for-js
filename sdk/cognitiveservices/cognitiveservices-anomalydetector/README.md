...
#### nodejs - client creation and shivangiTestDetectEntireSeries  as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.shivangiTestDetectEntireSeries(body).then((result) => {
...
#### browser - Authentication, client creation and shivangiTestDetectEntireSeries  as an example written in JavaScript.
