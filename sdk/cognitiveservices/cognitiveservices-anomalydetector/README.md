...
#### nodejs - client creation and breakingChangeDetectEntireSeries  as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.breakingChangeDetectEntireSeries(body).then((result) => {
...
#### browser - Authentication, client creation and breakingChangeDetectEntireSeries  as an example written in JavaScript.
