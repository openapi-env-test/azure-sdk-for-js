...
class AnomalyDetectorClient extends AnomalyDetectorClientContext {
  ...
  /**
   * Shivangi Testing This operation generates a model using an entire series, each point is detected
   * with the same model. With this method, points before and after a certain point are used to
   * determine whether it is an anomaly. The entire detection can give user an overall status of the
   * time series.
   * @summary Detect anomalies for the entire series in batch.
   * @param body Time series points and period if needed. Advanced model parameters can also be set
   * in the request.
   * @param [options] The optional parameters
   * @returns Promise<Models.BreakingChangeDetectEntireSeriesResponse>
   */
  breakingChangeDetectEntireSeries(body: Models.DetectRequest, options?: msRest.RequestOptionsBase): Promise<Models.BreakingChangeDetectEntireSeriesResponse>;
  /**
   * @param body Time series points and period if needed. Advanced model parameters can also be set
   * in the request.
   * @param callback The callback
   */
  breakingChangeDetectEntireSeries(body: Models.DetectRequest, callback: msRest.ServiceCallback<Models.EntireDetectResponse>): void;
  /**
   * @param body Time series points and period if needed. Advanced model parameters can also be set
   * in the request.
   * @param options The optional parameters
   * @param callback The callback
   */
  breakingChangeDetectEntireSeries(body: Models.DetectRequest, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.EntireDetectResponse>): void;
  breakingChangeDetectEntireSeries(body: Models.DetectRequest, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.EntireDetectResponse>, callback?: msRest.ServiceCallback<Models.EntireDetectResponse>): Promise<Models.BreakingChangeDetectEntireSeriesResponse> {
    return this.sendOperationRequest(
      {
        body,
        options
      },
      breakingChangeDetectEntireSeriesOperationSpec,
      callback) as Promise<Models.BreakingChangeDetectEntireSeriesResponse>;
  }
...
const breakingChangeDetectEntireSeriesOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
