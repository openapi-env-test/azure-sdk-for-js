...
class AnomalyDetectorClient extends AnomalyDetectorClientContext {
  ...
  /**
   * Testing This operation generates a model using an entire series, each point is detected with the
   * same model. With this method, points before and after a certain point are used to determine
   * whether it is an anomaly. The entire detection can give user an overall status of the time
   * series.
   * @summary Detect anomalies for the entire series in batch.
   * @param body Time series points and period if needed. Advanced model parameters can also be set
   * in the request.
   * @param [options] The optional parameters
   * @returns Promise<Models.ShivangiTestDetectEntireSeriesResponse>
   */
  shivangiTestDetectEntireSeries(body: Models.DetectRequest, options?: msRest.RequestOptionsBase): Promise<Models.ShivangiTestDetectEntireSeriesResponse>;
  /**
   * @param body Time series points and period if needed. Advanced model parameters can also be set
   * in the request.
   * @param callback The callback
   */
  shivangiTestDetectEntireSeries(body: Models.DetectRequest, callback: msRest.ServiceCallback<Models.EntireDetectResponse>): void;
  /**
   * @param body Time series points and period if needed. Advanced model parameters can also be set
   * in the request.
   * @param options The optional parameters
   * @param callback The callback
   */
  shivangiTestDetectEntireSeries(body: Models.DetectRequest, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.EntireDetectResponse>): void;
  shivangiTestDetectEntireSeries(body: Models.DetectRequest, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.EntireDetectResponse>, callback?: msRest.ServiceCallback<Models.EntireDetectResponse>): Promise<Models.ShivangiTestDetectEntireSeriesResponse> {
    return this.sendOperationRequest(
      {
        body,
        options
      },
      shivangiTestDetectEntireSeriesOperationSpec,
      callback) as Promise<Models.ShivangiTestDetectEntireSeriesResponse>;
  }
...
const shivangiTestDetectEntireSeriesOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
