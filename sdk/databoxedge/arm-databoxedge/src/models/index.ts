 ...
 * Optional Parameters.
 */
export interface LocationsListAvailableSkusOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 */
export type LocationsListAvailableSkusResponse = SkuInformationList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
