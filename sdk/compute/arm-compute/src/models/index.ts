...
export interface SecurityProfile {
  /**
   * This property can be used by user in the request to enable or disable Host Encryption for the
   * virtual machine or virtual machine scale set. This will enable the encryption for all the
   * disks including Temp disk at host itself. <br><br> Default: The Encryption at host will be
