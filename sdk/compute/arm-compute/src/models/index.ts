...
export interface HardwareProfile {
   ...
   * <br><br> This list of sizes is no longer updated and the **VirtualMachineSizeTypes** string
   * constants will be removed from the subsequent REST API specification. Use [List all available
   * virtual machine sizes in a region](
   * https://docs.microsoft.com/en-us/rest/api/compute/resourceskus/list) to get the latest sizes.
