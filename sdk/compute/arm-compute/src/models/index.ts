...
export interface OSProfile {
   ...
   * array is 65535 bytes. <br><br> This property cannot be updated after the VM is created.
   * <br><br> For using cloud-init for your VM, see [Using cloud-init to customize a Linux VM
   * during
...
export interface VirtualMachine extends Resource {
   ...
   * VM cannot be added to an availability set. <br><br>This property cannot exist along with a
