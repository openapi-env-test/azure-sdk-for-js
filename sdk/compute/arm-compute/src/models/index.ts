...
export interface OSProfile {
   ...
   * Azure VMs](https://docs.microsoft.com/azure/virtual-machines/custom-data) <br><br> For using
   * cloud-init for your Linux VM, see [Using cloud-init to customize a Linux VM during
