...
export interface ActivationProperties {
  /**
   * The activation status of the connected registry. Possible values include: 'Active', 'Inactive'
...
export interface SyncProperties {
  ...
  schedule?: string;
  /**
   * The time window during which sync is enabled for each schedule occurrence. Specify the
...
export interface TlsCertificateProperties {
  /**
   * The type of certificate location. Possible values include: 'LocalDirectory'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface TlsProperties {
  /**
   * Indicates whether HTTPS is enabled for the login server. Possible values include: 'Enabled',
   * 'Disabled'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface LoggingProperties {
  /**
   * The verbosity of logs persisted on the connected registry. Possible values include: 'Debug',
   * 'Information', 'Warning', 'Error', 'None'. Default value: 'Information'.
   */
  logLevel?: LogLevel;
  /**
   * Indicates whether audit logs are enabled on the connected registry. Possible values include:
...
export interface ConnectedRegistry extends ProxyResource {
   ...
   * Possible values include: 'Registry', 'Mirror'
   */
  ...
  /**
   * The current connection state of the connected registry. Possible values include: 'Online',
   * 'Offline', 'Syncing', 'Unhealthy'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface Registry extends Resource {
  ...
  /**
   * Whether to allow trusted Azure services to access a network restricted registry. Possible
   * values include: 'AzureServices', 'None'. Default value: 'AzureServices'.
   */
  networkRuleBypassOptions?: NetworkRuleBypassOptions;
  /**
   * Whether or not zone redundancy is enabled for this container registry. Possible values
...
export interface Replication extends Resource {
  ...
  /**
   * Whether or not zone redundancy is enabled for this container registry replication. Possible
 ...
 * Optional Parameters.
 */
export interface ConnectedRegistriesListOptionalParams extends msRest.RequestOptionsBase {
  /**
   * An OData filter expression that describes a subset of connectedRegistries to return. The
   * parameters that can be filtered are parent.id (the resource id of the connectedRegistry
   * parent), mode, and connectionState. The supported operator is eq.
   */
  filter?: string;
}
 ...
 * Optional Parameters.
 */
export interface ConnectedRegistriesListNextOptionalParams extends msRest.RequestOptionsBase {
  /**
   * An OData filter expression that describes a subset of connectedRegistries to return. The
   * parameters that can be filtered are parent.id (the resource id of the connectedRegistry
   * parent), mode, and connectionState. The supported operator is eq.
 ...
 * @extends Array<ConnectedRegistry>
 */
export interface ConnectedRegistryListResult extends Array<ConnectedRegistry> {
  /**
 ...
 * @enum {string}
 */
export type ConnectedRegistryMode = 'Registry' | 'Mirror';

/**
 * Defines values for ConnectionState.
 * Possible values include: 'Online', 'Offline', 'Syncing', 'Unhealthy'
 * @readonly
 * @enum {string}
 */
 ...
 * Possible values include: 'LocalDirectory'
 * @readonly
 * @enum {string}
 */
 ...
 * Possible values include: 'Debug', 'Information', 'Warning', 'Error', 'None'
 * @readonly
 * @enum {string}
 */
export type LogLevel = 'Debug' | 'Information' | 'Warning' | 'Error' | 'None';
 ...
 * @enum {string}
 */
export type AuditLogStatus = 'Enabled' | 'Disabled';
 ...
 * @enum {string}
 */
export type ZoneRedundancy = 'Enabled' | 'Disabled';
...
export type ConnectedRegistriesListResponse = ConnectedRegistryListResult & {
  ...
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: ConnectedRegistryListResult;
    };
};
 ...
 */
export type ConnectedRegistriesBeginCreateResponse = ConnectedRegistry & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type ConnectedRegistriesBeginUpdateResponse = ConnectedRegistry & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
