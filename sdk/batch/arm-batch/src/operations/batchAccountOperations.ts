...
export class BatchAccountOperations {
   ...
   * @param [options] The optional parameters
   * @returns Promise<Models.BatchAccountUpdateXXResponse>
   */
  updateXX(resourceGroupName: string, accountName: string, parameters: Models.BatchAccountUpdateParameters, options?: msRest.RequestOptionsBase): Promise<Models.BatchAccountUpdateXXResponse>;
  /**
   * @param resourceGroupName The name of the resource group that contains the Batch account.
   * @param accountName The name of the Batch account.
   * @param parameters Additional parameters for account update.
   ...
   */
  updateXX(resourceGroupName: string, accountName: string, parameters: Models.BatchAccountUpdateParameters, callback: msRest.ServiceCallback<Models.BatchAccount>): void;
  /**
   * @param resourceGroupName The name of the resource group that contains the Batch account.
   * @param accountName The name of the Batch account.
   * @param parameters Additional parameters for account update.
   ...
   * @param callback The callback
   */
  updateXX(resourceGroupName: string, accountName: string, parameters: Models.BatchAccountUpdateParameters, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BatchAccount>): void;
  updateXX(resourceGroupName: string, accountName: string, parameters: Models.BatchAccountUpdateParameters, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BatchAccount>, callback?: msRest.ServiceCallback<Models.BatchAccount>): Promise<Models.BatchAccountUpdateXXResponse> {
    return this.client.sendOperationRequest(
      ...
      updateXXOperationSpec,
      callback) as Promise<Models.BatchAccountUpdateXXResponse>;
  }
...
const updateXXOperationSpec: msRest.OperationSpec = {
  httpMethod: "PATCH",
