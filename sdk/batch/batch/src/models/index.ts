...
/**
 * On every file upload, Batch service writes two log files to the compute node, fileuploadout.txt
 * and fileuploaderr.txt. These log files are used to learn more about a specific failure.
