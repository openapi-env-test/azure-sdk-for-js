...
export const Controller: msRest.CompositeMapper = {
  ...
  type: {
    ...
    modelProperties: {
      ...
      hostEndpointType: {
        serializedName: "properties.hostEndpointType",
        type: {
          name: "String"
        }
      },
...
export const ListConnectionDetailsParameters: msRest.CompositeMapper = {
...
export const DevSpacesErrorResponse: msRest.CompositeMapper = {
