...
// @public
export type ScannerConfiguration = Resource & {
    scanningMode?: ScanningMode;
    exclusionTags?: {
        [propertyName: string]: string;
    };
...
// @public
export interface ScannerConfigurationList {
    // (undocumented)
    value?: ScannerConfiguration[];
}
...
export interface VmScanners {
    createOrUpdate(vmScannerName: string, options?: VmScannersCreateOrUpdateOptionalParams): Promise<VmScannersCreateOrUpdateResponse>;
    delete(vmScannerName: string, options?: VmScannersDeleteOptionalParams): Promise<void>;
    get(vmScannerName: string, options?: VmScannersGetOptionalParams): Promise<VmScannersGetResponse>;
    listBySubscription(options?: VmScannersListBySubscriptionOptionalParams): Promise<VmScannersListBySubscriptionResponse>;
}

// @public
export interface VmScannersCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}

// @public
export type VmScannersCreateOrUpdateResponse = ScannerConfiguration;

// @public
export interface VmScannersDeleteOptionalParams extends coreClient.OperationOptions {
}

// @public
export interface VmScannersGetOptionalParams extends coreClient.OperationOptions {
}

// @public
export type VmScannersGetResponse = ScannerConfiguration;

// @public
export interface VmScannersListBySubscriptionOptionalParams extends coreClient.OperationOptions {
}

// @public
export type VmScannersListBySubscriptionResponse = ScannerConfigurationList;
