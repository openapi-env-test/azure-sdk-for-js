...
**Features**
  ...
  - Added operation group VmScanners
  ...
  - Added Interface ScannerConfigurationList
  ...
  - Added Interface VmScannersCreateOrUpdateOptionalParams
  - Added Interface VmScannersDeleteOptionalParams
  - Added Interface VmScannersGetOptionalParams
  - Added Interface VmScannersListBySubscriptionOptionalParams
  ...
  - Added Type Alias ScannerConfiguration
  ...
  - Added Type Alias VmScannersCreateOrUpdateResponse
  - Added Type Alias VmScannersGetResponse
  - Added Type Alias VmScannersListBySubscriptionResponse
  ...
  - Class SecurityCenter has a new parameter vmScanners
