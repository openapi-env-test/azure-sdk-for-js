...
export class SecureScores {
   ...
   */
  list(scope: string, options?: msRest.RequestOptionsBase): Promise<Models.SecureScoresListResponse>;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   */
  list(scope: string, callback: msRest.ServiceCallback<Models.SecureScoresList>): void;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   * @param callback The callback
   */
  list(scope: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SecureScoresList>): void;
  list(scope: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SecureScoresList>, callback?: msRest.ServiceCallback<Models.SecureScoresList>): Promise<Models.SecureScoresListResponse> {
   ...
   */
  get(scope: string, secureScoreName: string, options?: msRest.RequestOptionsBase): Promise<Models.SecureScoresGetResponse>;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   * @param callback The callback
   */
  get(scope: string, secureScoreName: string, callback: msRest.ServiceCallback<Models.SecureScoreItem>): void;
  /**
   * @param scope Scope of the query, can be subscription
   * (/subscriptions/0b06d9ea-afe6-4779-bd59-30e5c2d9d13f) or management group
   * (/providers/Microsoft.Management/managementGroups/mgName).
   ...
   * @param callback The callback
   */
  get(scope: string, secureScoreName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.SecureScoreItem>): void;
  get(scope: string, secureScoreName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.SecureScoreItem>, callback?: msRest.ServiceCallback<Models.SecureScoreItem>): Promise<Models.SecureScoresGetResponse> {
    return this.client.sendOperationRequest(
      {
        scope,
        secureScoreName,
...
const listOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  path: "{scope}/providers/Microsoft.Security/secureScores",
  urlParameters: [
    Parameters.scope
  ],
  queryParameters: [
...
const getOperationSpec: msRest.OperationSpec = {
  httpMethod: "GET",
  path: "{scope}/providers/Microsoft.Security/secureScores/{secureScoreName}",
  urlParameters: [
    Parameters.scope,
