...
export const ScannerConfigurationList: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ScannerConfigurationList",
    modelProperties: {
      value: {
        serializedName: "value",
        type: {
          ...
          element: {
            type: {
              name: "Composite",
              className: "ScannerConfiguration"
            }
          }
        }
      }
...
export const ScannerConfiguration: coreClient.CompositeMapper = {
  type: {
    name: "Composite",
    className: "ScannerConfiguration",
    modelProperties: {
      ...Resource.type.modelProperties,
      scanningMode: {
        serializedName: "properties.scanningMode",
        type: {
          name: "String"
        }
      },
      exclusionTags: {
        serializedName: "properties.exclusionTags",
        type: {
          name: "Dictionary",
          value: { type: { name: "String" } }
        }
