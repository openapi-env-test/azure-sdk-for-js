...
export const AppWhitelistingPutGroupData: msRest.CompositeMapper = {
  serializedName: "AppWhitelistingPutGroupData",
  type: {
    name: "Composite",
    className: "AppWhitelistingPutGroupData",
    modelProperties: {
      enforcementMode: {
      ...
      vmRecommendations: {
        serializedName: "vmRecommendations",
        type: {
          name: "Sequence",
          element: {
            type: {
      ...
      pathRecommendations: {
        serializedName: "pathRecommendations",
        type: {
          name: "Sequence",
          element: {
            type: {
...
export const AwsResourceDetails: msRest.CompositeMapper = {
  serializedName: "Aws",
  type: {
    name: "Composite",
    polymorphicDiscriminator: ResourceDetails.type.polymorphicDiscriminator,
    uberParent: "ResourceDetails",
    className: "AwsResourceDetails",
    modelProperties: {
      ...ResourceDetails.type.modelProperties,
      accountId: {
        readOnly: true,
...
export const AutomationMetadata: msRest.CompositeMapper = {
  serializedName: "AutomationMetadata",
  type: {
    name: "Composite",
    className: "AutomationMetadata",
    modelProperties: {
      createdDateTimeUtc: {
        readOnly: true,
...
export const AutomationActionLogicAppInput: msRest.CompositeMapper = {
  serializedName: "LogicApp",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AutomationAction.type.polymorphicDiscriminator,
    uberParent: "AutomationAction",
    className: "AutomationActionLogicAppInput",
    modelProperties: {
      ...AutomationActionLogicApp.type.modelProperties,
      uri: {
        serializedName: "uri",
        type: {
          name: "String"
...
export const AutomationActionLogicAppOutput: msRest.CompositeMapper = {
  serializedName: "LogicApp",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AutomationAction.type.polymorphicDiscriminator,
    uberParent: "AutomationAction",
    className: "AutomationActionLogicAppOutput",
    modelProperties: {
      ...AutomationActionLogicApp.type.modelProperties
    }
  }
...
export const AutomationActionEventHubInput: msRest.CompositeMapper = {
  serializedName: "EventHub",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AutomationAction.type.polymorphicDiscriminator,
    uberParent: "AutomationAction",
    className: "AutomationActionEventHubInput",
    modelProperties: {
      ...AutomationActionEventHub.type.modelProperties,
      connectionString: {
...
export const AutomationActionEventHubOutput: msRest.CompositeMapper = {
  serializedName: "EventHub",
  type: {
    name: "Composite",
    polymorphicDiscriminator: AutomationAction.type.polymorphicDiscriminator,
    uberParent: "AutomationAction",
    className: "AutomationActionEventHubOutput",
    modelProperties: {
      ...AutomationActionEventHub.type.modelProperties,
      sasPolicyName: {
...
export const discriminators = {
  ...
  'ResourceDetails.Aws' : AwsResourceDetails,
  ...
  'AutomationAction.LogicApp' : AutomationActionLogicAppInput,
  'AutomationAction.LogicApp' : AutomationActionLogicAppOutput,
  'AutomationAction.EventHub' : AutomationActionEventHub,
  'AutomationAction.EventHub' : AutomationActionEventHubInput,
  'AutomationAction.EventHub' : AutomationActionEventHubOutput,
