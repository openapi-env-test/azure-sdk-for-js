 ...
 */
export type ResourceDetailsUnion = ResourceDetails | AzureResourceDetails | AwsResourceDetails;
...
export interface AwsResourceDetails {
  ...
  /**
   * AWS resource ID. can be ARN or other
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface AutomationMetadata {
  /**
   * The security automation creation date.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly createdDateTimeUtc?: Date;
  /**
   * The AAD object ID of the entity that created the security automation.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly createdBy?: string;
  /**
   * The security automation last updated date.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly lastUpdatedDateTimeUtc?: Date;
  /**
   * The AAD object ID of the entity that last updated the security automation.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
export interface AutomationTriggeringRule {
  ...
  /**
   * A valid comparer operator to use. Possible values include: 'Equals', 'GreaterThan',
 ...
 */
export type AutomationActionUnion = AutomationAction | AutomationActionLogicAppUnion | AutomationActionEventHubUnion | AutomationActionWorkspace;
...
/**
 * Contains the possible cases for AutomationActionLogicApp.
 */
export type AutomationActionLogicAppUnion = AutomationActionLogicApp | AutomationActionLogicAppInput | AutomationActionLogicAppOutput;
 ...
 * The logic app action that should be triggered.
 */
export interface AutomationActionLogicAppInput {
  /**
   * Polymorphic Discriminator
   */
  actionType: "LogicApp";
  ...
  logicAppResourceId?: string;
  /**
   * The Logic App trigger URI endpoint.
   */
  uri?: string;
}
 ...
 * The logic app action that should be triggered.
 */
export interface AutomationActionLogicAppOutput {
  /**
   * Polymorphic Discriminator
   */
  actionType: "LogicApp";
...
/**
 * Contains the possible cases for AutomationActionEventHub.
 */
export type AutomationActionEventHubUnion = AutomationActionEventHub | AutomationActionEventHubInput | AutomationActionEventHubOutput;
 ...
 * The target Event Hub to which event data will be exported.
 */
export interface AutomationActionEventHubInput {
  /**
   * Polymorphic Discriminator
   */
  actionType: "EventHub";
 ...
 * The target Event Hub to which event data will be exported.
 */
export interface AutomationActionEventHubOutput {
  /**
   * Polymorphic Discriminator
   */
  actionType: "EventHub";
 ...
 * @enum {string}
 */
export type AssessmentType = 'BuiltIn' | 'CustomPolicy' | 'CustomerManaged';
 ...
 * Contains response data for the list operation.
 */
export type AssessmentsMetadataSubscriptionListResponse = SecurityAssessmentMetadataList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the get operation.
 */
export type AssessmentsMetadataSubscriptionGetResponse = SecurityAssessmentMetadata & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the create operation.
 */
export type AssessmentsMetadataSubscriptionCreateResponse = SecurityAssessmentMetadata & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listNext operation.
 */
export type AssessmentsMetadataSubscriptionListNextResponse = SecurityAssessmentMetadataList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
