...
export type ScannerConfiguration = Resource & {
  /** The scanning mode. */
  scanningMode?: ScanningMode;
  /** Dictionary of string key-value pairs representing the tags used to exclude resources from being scanned. Resources tagged with one of these values will not be scanned. The values in the dictionary are case-sensitive */
...
/** Optional parameters. */
export interface VmScannersGetOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface VmScannersCreateOrUpdateOptionalParams
  extends coreClient.OperationOptions {}
...
/** Optional parameters. */
export interface VmScannersDeleteOptionalParams
  extends coreClient.OperationOptions {}

/** Optional parameters. */
export interface VmScannersListBySubscriptionOptionalParams
  extends coreClient.OperationOptions {}
