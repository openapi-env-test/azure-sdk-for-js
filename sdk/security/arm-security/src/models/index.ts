...
export interface Alert extends Resource {
  ...
  readonly description?: string;
  /**
   * The risk level of the threat that was detected. Possible Values: Informational, Low, Medium,
   * and High. Learn more:
  ...
  /**
   * The resource identifiers for this alert which can be used to direct the alert to the right
   * product exposure group (tenant, workspace, subscription etc.). There can be multiple
  ...
  readonly vendorName?: string;
  /**
   * The life cycle status of the alert. Supported statuses are: Active, Resolved, Dismissed.
   ...
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
  readonly extendedLinks?: { [propertyName: string]: any }[];
  /**
 ...
 * Optional Parameters.
 */
export interface AlertsListSubscriptionLevelByRegionOptionalParams extends msRest.RequestOptionsBase {
  /**
   * OData filter. Optional.
   */
  filter?: string;
 ...
 * Optional Parameters.
 */
export interface AlertsListResourceGroupLevelByRegionOptionalParams extends msRest.RequestOptionsBase {
  /**
   * OData filter. Optional.
   */
  filter?: string;
