...
export interface ShippingAddress {
  ...
  companyName?: string;
  /**
   * Type of address. Possible values include: 'None', 'Residential', 'Commercial'. Default value:
   * 'None'.
   */
...
export interface NotificationPreference {
  ...
  /**
   * Notification is required or not. Default value: true.
   */
...
export interface TransferFilterDetails {
  /**
   * Type of the account of data. Possible values include: 'StorageAccount', 'ManagedDisk'. Default
...
export interface DataExportDetails {
  ...
  /**
   * Level of the logs to be collected. Possible values include: 'Error', 'Verbose'. Default value:
   * 'Error'.
   */
...
export interface JobResource extends Resource {
  ...
  /**
   * Delivery type of Job. Possible values include: 'NonScheduled', 'Scheduled'. Default value:
   * 'NonScheduled'.
   */
