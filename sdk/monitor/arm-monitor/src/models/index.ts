 ...
 * * __Leaf Condition__ - must contain 'field' and either 'equals' or 'containsAny'.
 * _Please note, 'anyOf' should __not__ exist in a Leaf Condition._
 * * __AnyOf Condition__ - must contain 'anyOf' (which is an array of Leaf Conditions).
 * _Please note, 'field', 'equals' and 'containsAny' should __not__ exist in an AnyOf Condition._
 ...
 */
export interface AlertRuleResource extends AzureResource {
  /**
 ...
 */
export interface AlertRuleList extends Array<AlertRuleResource> {
  /**
 ...
 */
export type ActivityLogAlertRuleCreateOrUpdateResponse = AlertRuleResource & {
  /**
 ...
 */
export type ActivityLogAlertRuleGetResponse = AlertRuleResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type ActivityLogAlertRuleUpdateResponse = AlertRuleResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type ActivityLogAlertRuleListBySubscriptionIdResponse = AlertRuleList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type ActivityLogAlertRuleListByResourceGroupResponse = AlertRuleList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type ActivityLogAlertRuleListBySubscriptionIdNextResponse = AlertRuleList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type ActivityLogAlertRuleListByResourceGroupNextResponse = AlertRuleList & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
