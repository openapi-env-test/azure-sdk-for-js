...
class SubscriptionClient extends SubscriptionClientContext {
  // Operation groups
  getOperationStatus: operations.GetOperationStatus;
  supportPlan: operations.SupportPlan;
  ...
  constructor(credentials: msRest.ServiceClientCredentials, options?: Models.SubscriptionClientOptions) {
    ...
    this.getOperationStatus = new operations.GetOperationStatus(this);
    this.supportPlan = new operations.SupportPlan(this);
