...
export interface LeaseContainerRequestAutoGenerated {
  /** Specifies the lease action. Can be one of the available actions. */
  action: LeaseContainerRequest;
...
/** Known values of {@link LeaseContainerRequest} that the service accepts. */
export enum KnownLeaseContainerRequest {
  Acquire = "Acquire",
  Renew = "Renew",
  Change = "Change",
  Release = "Release",
 ...
 * {@link KnownLeaseContainerRequest} can be used interchangeably with LeaseContainerRequest,
 *  this enum contains the known values that the service supports.
 * ### Known values supported by the service
 * **Acquire** \
 * **Renew** \
 ...
 * **Break**
 */
export type LeaseContainerRequest = string;
...
export interface BlobContainersLeaseOptionalParams
  ...
  parameters?: LeaseContainerRequestAutoGenerated;
}
