...
export interface Applications {
    ...
    updateAccess(resourceGroupName: string, applicationName: string, parameters: UpdateAccessDefinition, options?: ApplicationsUpdateAccessOptionalParams): Promise<ApplicationsUpdateAccessResponse>;
...
// @public
export type ApplicationsUpdateAccessResponse = UpdateAccessDefinition;
