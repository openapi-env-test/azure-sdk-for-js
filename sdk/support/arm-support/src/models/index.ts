...
export interface QuotaTicketDetails {
  /**
   * Required for certain quota types when there is a sub type that you are requesting quota
...
export interface SupportTicketDetails extends BaseResource {
  ...
  description: string;
  /**
   * Each Azure service has its own set of issue category called problem classification that
   * corresponds to the type of problem you're experiencing. This parameter is the resource id of
   ...
   * Note: 'Highest critical impact' severity is reserved only to our Premium customers. Possible
...
export interface SupportTicketsListOptionalParams extends msRest.RequestOptionsBase {
   ...
   * only be used with 'eq' operator. For _CreatedDate_ filter, the supported operators are 'gt'
