...
export class SupportTickets {
  ...
  /**
   * Check the availability of a resource name. This API should to be used to check the uniqueness of
   ...
   * problem categories required for support ticket creation.<br/><br/>Adding attachments are not
   ...
   * currently not supported via the API. Azure support engineer, working on your ticket, will reach
   * out to you for consent if your issue requires gathering diagnostic information from your Azure
