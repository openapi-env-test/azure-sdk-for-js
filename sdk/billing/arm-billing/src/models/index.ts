 ...
 * @enum {string}
 */
export type InvoiceStatus = 'PastDue' | 'Due' | 'Paid' | 'Void';
 ...
 * @enum {string}
 */
export type DocumentType = 'Invoice' | 'VoidNote' | 'Receipt' | 'CreditNote';
 ...
 * Contains response data for the get operation.
 */
export type LineOfCreditsGetResponse = LineOfCredit & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
