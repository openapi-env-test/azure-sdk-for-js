 ...
 * Optional Parameters.
 */
export interface ProductsUpdateAutoRenewOptionalParams extends msRest.RequestOptionsBase {
  /**
   * The flag that determines the auto-renew settings for a product. Possible values include:
   * 'true', 'false'
   */
 ...
 * Optional Parameters.
 */
export interface EnrollmentAccountsGetOptionalParams extends msRest.RequestOptionsBase {
  /**
   * May be used to expand the department.
   */
  expand?: string;
 ...
 * @extends Array<Department>
 */
export interface DepartmentListResult extends Array<Department> {
  /**
   * The link (url) to the next page of results.
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
...
/**
 * Contains response data for the updateAutoRenew operation.
 */
export type ProductsUpdateAutoRenewResponse = UpdateAutoRenewOperation & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type DepartmentsListByBillingAccountNameNextResponse = DepartmentListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the listByBillingAccountNameNext operation.
 */
export type EnrollmentAccountsListByBillingAccountNameNextResponse = EnrollmentAccountListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
