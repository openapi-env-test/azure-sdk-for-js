...
export class BillingSubscriptions {
   ...
   */
  get(billingAccountName: string, billingSubscriptionName: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingSubscriptionsGetResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingSubscriptionName The ID that uniquely identifies a subscription.
   * @param callback The callback
   */
  get(billingAccountName: string, billingSubscriptionName: string, callback: msRest.ServiceCallback<Models.BillingSubscription>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingSubscriptionName The ID that uniquely identifies a subscription.
   * @param options The optional parameters
   * @param callback The callback
   */
  get(billingAccountName: string, billingSubscriptionName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BillingSubscription>): void;
  get(billingAccountName: string, billingSubscriptionName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BillingSubscription>, callback?: msRest.ServiceCallback<Models.BillingSubscription>): Promise<Models.BillingSubscriptionsGetResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
   ...
   */
  update(billingAccountName: string, billingSubscriptionName: string, parameters: Models.BillingSubscription, options?: msRest.RequestOptionsBase): Promise<Models.BillingSubscriptionsUpdateResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingSubscriptionName The ID that uniquely identifies a subscription.
   * @param parameters Request parameters that are provided to the update billing subscription
   ...
   * @param callback The callback
   */
  update(billingAccountName: string, billingSubscriptionName: string, parameters: Models.BillingSubscription, callback: msRest.ServiceCallback<Models.BillingSubscription>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingSubscriptionName The ID that uniquely identifies a subscription.
   * @param parameters Request parameters that are provided to the update billing subscription
   ...
   * @param callback The callback
   */
  update(billingAccountName: string, billingSubscriptionName: string, parameters: Models.BillingSubscription, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.BillingSubscription>): void;
  update(billingAccountName: string, billingSubscriptionName: string, parameters: Models.BillingSubscription, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.BillingSubscription>, callback?: msRest.ServiceCallback<Models.BillingSubscription>): Promise<Models.BillingSubscriptionsUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
        billingSubscriptionName,
   ...
   */
  move(billingAccountName: string, billingSubscriptionName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingSubscriptionsMoveResponse> {
    return this.beginMove(billingAccountName,billingSubscriptionName,destinationInvoiceSectionId,options)
   ...
   */
  validateMove(billingAccountName: string, billingSubscriptionName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase): Promise<Models.BillingSubscriptionsValidateMoveResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingSubscriptionName The ID that uniquely identifies a subscription.
   * @param destinationInvoiceSectionId The destination invoice section id.
   * @param callback The callback
   */
  validateMove(billingAccountName: string, billingSubscriptionName: string, destinationInvoiceSectionId: string, callback: msRest.ServiceCallback<Models.ValidateSubscriptionTransferEligibilityResult>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param billingSubscriptionName The ID that uniquely identifies a subscription.
   * @param destinationInvoiceSectionId The destination invoice section id.
   ...
   * @param callback The callback
   */
  validateMove(billingAccountName: string, billingSubscriptionName: string, destinationInvoiceSectionId: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.ValidateSubscriptionTransferEligibilityResult>): void;
  validateMove(billingAccountName: string, billingSubscriptionName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.ValidateSubscriptionTransferEligibilityResult>, callback?: msRest.ServiceCallback<Models.ValidateSubscriptionTransferEligibilityResult>): Promise<Models.BillingSubscriptionsValidateMoveResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
        billingSubscriptionName,
   ...
   */
  beginMove(billingAccountName: string, billingSubscriptionName: string, destinationInvoiceSectionId: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
