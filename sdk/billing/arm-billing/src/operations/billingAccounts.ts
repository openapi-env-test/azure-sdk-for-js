...
export class BillingAccounts {
   ...
   */
  update(billingAccountName: string, patch: Models.JsonPatchOperation[], options?: msRest.RequestOptionsBase): Promise<Models.BillingAccountsUpdateResponse> {
    return this.beginUpdate(billingAccountName,patch,options)
   ...
   */
  beginUpdate(billingAccountName: string, patch: Models.JsonPatchOperation[], options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
