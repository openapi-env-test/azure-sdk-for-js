...
export class BillingProfiles {
   ...
   */
  update(billingAccountName: string, billingProfileName: string, patch: Models.JsonPatchOperation[], options?: msRest.RequestOptionsBase): Promise<Models.BillingProfilesUpdateResponse> {
    return this.beginUpdate(billingAccountName,billingProfileName,patch,options)
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginUpdate(billingAccountName: string, billingProfileName: string, patch: Models.JsonPatchOperation[], options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        billingAccountName,
        billingProfileName,
