...
export class InvoiceSections {
   ...
   */
  update(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, patch: Models.JsonPatchOperation[], options?: msRest.RequestOptionsBase): Promise<Models.InvoiceSectionsUpdateResponse> {
    return this.beginUpdate(billingAccountName,billingProfileName,invoiceSectionName,patch,options)
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginUpdate(billingAccountName: string, billingProfileName: string, invoiceSectionName: string, patch: Models.JsonPatchOperation[], options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        billingAccountName,
        billingProfileName,
