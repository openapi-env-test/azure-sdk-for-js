...
export class Products {
   ...
   * @param productName The ID that uniquely identifies a product.
   * @param [options] The optional parameters
   * @returns Promise<Models.ProductsUpdateAutoRenewResponse>
   */
  updateAutoRenew(billingAccountName: string, productName: string, options?: Models.ProductsUpdateAutoRenewOptionalParams): Promise<Models.ProductsUpdateAutoRenewResponse>;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param productName The ID that uniquely identifies a product.
   * @param callback The callback
   */
  updateAutoRenew(billingAccountName: string, productName: string, callback: msRest.ServiceCallback<Models.UpdateAutoRenewOperation>): void;
  /**
   * @param billingAccountName The ID that uniquely identifies a billing account.
   * @param productName The ID that uniquely identifies a product.
   * @param options The optional parameters
   * @param callback The callback
   */
  updateAutoRenew(billingAccountName: string, productName: string, options: Models.ProductsUpdateAutoRenewOptionalParams, callback: msRest.ServiceCallback<Models.UpdateAutoRenewOperation>): void;
  updateAutoRenew(billingAccountName: string, productName: string, options?: Models.ProductsUpdateAutoRenewOptionalParams | msRest.ServiceCallback<Models.UpdateAutoRenewOperation>, callback?: msRest.ServiceCallback<Models.UpdateAutoRenewOperation>): Promise<Models.ProductsUpdateAutoRenewResponse> {
    return this.client.sendOperationRequest(
      {
        billingAccountName,
        productName,
      ...
      updateAutoRenewOperationSpec,
      callback) as Promise<Models.ProductsUpdateAutoRenewResponse>;
  }
...
const updateAutoRenewOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
