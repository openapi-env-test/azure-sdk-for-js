...
export class SignalRPrivateEndpointConnections {
   ...
   * @param resourceName The name of the SignalR resource.
   * @param [options] The optional parameters
   * @returns Promise<Models.SignalRPrivateEndpointConnectionsCreateResponse>
   */
  create(privateEndpointConnectionName: string, resourceGroupName: string, resourceName: string, options?: Models.SignalRPrivateEndpointConnectionsCreateOptionalParams): Promise<Models.SignalRPrivateEndpointConnectionsCreateResponse> {
    return this.beginCreate(privateEndpointConnectionName,resourceGroupName,resourceName,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.SignalRPrivateEndpointConnectionsCreateResponse>;
  }
   ...
   */
  beginCreate(privateEndpointConnectionName: string, resourceGroupName: string, resourceName: string, options?: Models.SignalRPrivateEndpointConnectionsBeginCreateOptionalParams): Promise<msRestAzure.LROPoller> {
