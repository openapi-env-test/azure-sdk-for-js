...
/**
 * An interface representing RecoveryPointsFilters.
 */
...
export interface AzureBackupFindRestorableTimeRangesRequest {
  /**
   * Gets or sets the type of the source data store. Possible values include: 'OperationalStore',
...
/**
 * An interface representing DppWorkerRequest.
 */
...
/**
 * An interface representing RestorableTimeRange.
 */
 ...
 * @summary AzureBackupRecoveryTimeBasedRestoreRequest
 */
...
export interface BackupInstance {
  ...
  /**
   * Specifies the current protection state of the resource. Possible values include: 'Invalid',
   * 'NotProtected', 'ConfiguringProtection', 'ProtectionConfigured', 'BackupSchedulesSuspended',
   * 'RetentionSchedulesSuspended', 'ProtectionStopped', 'ProtectionError',
   * 'ConfiguringProtectionFailed', 'SoftDeleting', 'SoftDeleted', 'UpdatingProtection'
   * **NOTE: This property will not be serialized. It can only be populated by the server.**
   */
 ...
 * Optional Parameters.
 */
export interface RecoveryPointsGetListOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 * Optional Parameters.
 */
export interface RecoveryPointsGetListNextOptionalParams extends msRest.RequestOptionsBase {
  /**
   * OData filter options.
   */
  filter?: string;
 ...
 * @enum {string}
 */
export type RestoreSourceDataStoreType = 'OperationalStore' | 'VaultStore' | 'ArchiveStore';
 ...
 * @enum {string}
 */
export type CurrentProtectionState = 'Invalid' | 'NotProtected' | 'ConfiguringProtection' | 'ProtectionConfigured' | 'BackupSchedulesSuspended' | 'RetentionSchedulesSuspended' | 'ProtectionStopped' | 'ProtectionError' | 'ConfiguringProtectionFailed' | 'SoftDeleting' | 'SoftDeleted' | 'UpdatingProtection';
 ...
 */
export type BackupVaultsBeginCreateOrUpdateResponse = BackupVaultResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the get operation.
 */
export type OperationResultGetResponse = OperationJobExtendedInfo & OperationResultGetHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       */
      parsedHeaders: OperationResultGetHeaders;
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: OperationJobExtendedInfo;
    };
};
 ...
 */
export type BackupInstancesAdhocBackupResponse = OperationJobExtendedInfo & BackupInstancesAdhocBackupHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type BackupInstancesValidateForBackupResponse = OperationJobExtendedInfo & BackupInstancesValidateForBackupHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type BackupInstancesTriggerRestoreResponse = OperationJobExtendedInfo & BackupInstancesTriggerRestoreHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type BackupInstancesValidateRestoreResponse = OperationJobExtendedInfo & BackupInstancesValidateRestoreHeaders & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 * Contains response data for the beginCreateOrUpdate operation.
 */
export type BackupInstancesBeginCreateOrUpdateResponse = BackupInstanceResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type FindRestorableTimeRangesPostResponse = AzureBackupFindRestorableTimeRangesResponseResource & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
       ...
       * The response body as parsed JSON or XML
       */
      parsedBody: AzureBackupFindRestorableTimeRangesResponseResource;
    };
};
