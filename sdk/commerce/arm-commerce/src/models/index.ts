 ...
 * Optional Parameters.
 */
export interface UsageAggregatesTestOptionalParams extends msRest.RequestOptionsBase {
  /**
 ...
 * Optional Parameters.
 */
export interface UsageAggregatesTestNextOptionalParams extends msRest.RequestOptionsBase {
  /**
   * `True` returns usage data in instance-level detail, `false` causes server-side aggregation
   * with fewer details. For example, if you have 3 website instances, by default you will get 3
   * line items for website consumption. If you specify showDetails = false, the data will be
 ...
 */
export type UsageAggregatesTestResponse = UsageAggregationListResult & {
  /**
...
/**
 * Contains response data for the testNext operation.
 */
export type UsageAggregatesTestNextResponse = UsageAggregationListResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
