 ...
 * @enum {string}
 */
export type ProvisioningState = 'Creating' | 'Deleting' | 'Updating' | 'Unknown' | 'Succeeded' | 'Failed';
 ...
 */
export type DatabasesImportDatabaseResponse = ImportExportOperationResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
 ...
 */
export type DatabasesBeginImportDatabaseResponse = ImportExportOperationResult & {
  /**
   * The underlying HTTP response.
   */
  _response: msRest.HttpResponse & {
