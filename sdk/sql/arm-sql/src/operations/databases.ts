...
export class Databases {
   ...
   * @param parameters The database import request parameters.
   * @param [options] The optional parameters
   * @returns Promise<Models.DatabasesImportDatabaseResponse>
   */
  importDatabase(resourceGroupName: string, serverName: string, parameters: Models.ImportNewDatabaseDefinition, options?: msRest.RequestOptionsBase): Promise<Models.DatabasesImportDatabaseResponse> {
    return this.beginImportDatabase(resourceGroupName,serverName,parameters,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.DatabasesImportDatabaseResponse>;
  }
