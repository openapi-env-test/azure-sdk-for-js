...
import { ManagedServerDnsAliases } from "../operationsInterfaces";
...
import {
  ...
  ManagedServerDnsAliasesListByManagedInstanceNextOptionalParams,
...
/** Class containing ManagedServerDnsAliases operations. */
export class ManagedServerDnsAliasesImpl implements ManagedServerDnsAliases {
  private readonly client: SqlManagementClient;

  /**
   * Initialize a new instance of the class ManagedServerDnsAliases class.
  ...
  async beginCreateOrUpdate(
    ...
    PollerLike<
      PollOperationState<ManagedServerDnsAliasesCreateOrUpdateResponse>,
      ManagedServerDnsAliasesCreateOrUpdateResponse
    >
  > {
  ...
  async beginAcquire(
    ...
    PollerLike<
      PollOperationState<ManagedServerDnsAliasesAcquireResponse>,
      ManagedServerDnsAliasesAcquireResponse
    >
  > {
    const directSendOperation = async (
