...
export class DatabaseAdvisors {
   ...
   * @param callback The callback
   */
  listByDatabase(resourceGroupName: string, serverName: string, databaseName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.Advisor[]>): void;
  listByDatabase(resourceGroupName: string, serverName: string, databaseName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.Advisor[]>, callback?: msRest.ServiceCallback<Models.Advisor[]>): Promise<Models.DatabaseAdvisorsListByDatabaseResponse> {
