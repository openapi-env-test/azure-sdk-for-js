...
export class ServerAdvisors {
   ...
   */
  listByServer(resourceGroupName: string, serverName: string, options?: msRest.RequestOptionsBase): Promise<Models.ServerAdvisorsListByServerResponse>;
  /**
   * @param resourceGroupName The name of the resource group that contains the resource. You can
   * obtain this value from the Azure Resource Manager API or the portal.
   * @param serverName The name of the server.
   ...
   */
  listByServer(resourceGroupName: string, serverName: string, callback: msRest.ServiceCallback<Models.AdvisorListResult>): void;
  /**
   * @param resourceGroupName The name of the resource group that contains the resource. You can
   * obtain this value from the Azure Resource Manager API or the portal.
   * @param serverName The name of the server.
   ...
   * @param callback The callback
   */
  listByServer(resourceGroupName: string, serverName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.AdvisorListResult>): void;
  listByServer(resourceGroupName: string, serverName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.AdvisorListResult>, callback?: msRest.ServiceCallback<Models.AdvisorListResult>): Promise<Models.ServerAdvisorsListByServerResponse> {
   ...
   * @param parameters The requested advisor resource state.
   * @param [options] The optional parameters
   * @returns Promise<Models.ServerAdvisorsCreateOrUpdateResponse>
   */
  createOrUpdate(resourceGroupName: string, serverName: string, advisorName: string, parameters: Models.Advisor, options?: msRest.RequestOptionsBase): Promise<Models.ServerAdvisorsCreateOrUpdateResponse>;
  /**
   * @param resourceGroupName The name of the resource group that contains the resource. You can
   * obtain this value from the Azure Resource Manager API or the portal.
   * @param serverName The name of the server.
   ...
   * @param callback The callback
   */
  createOrUpdate(resourceGroupName: string, serverName: string, advisorName: string, parameters: Models.Advisor, callback: msRest.ServiceCallback<Models.Advisor>): void;
  /**
   * @param resourceGroupName The name of the resource group that contains the resource. You can
   * obtain this value from the Azure Resource Manager API or the portal.
   * @param serverName The name of the server.
   ...
   * @param callback The callback
   */
  createOrUpdate(resourceGroupName: string, serverName: string, advisorName: string, parameters: Models.Advisor, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.Advisor>): void;
  createOrUpdate(resourceGroupName: string, serverName: string, advisorName: string, parameters: Models.Advisor, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.Advisor>, callback?: msRest.ServiceCallback<Models.Advisor>): Promise<Models.ServerAdvisorsCreateOrUpdateResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        serverName,
      ...
      callback) as Promise<Models.ServerAdvisorsCreateOrUpdateResponse>;
  }
}
