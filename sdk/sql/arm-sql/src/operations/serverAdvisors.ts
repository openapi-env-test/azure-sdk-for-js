...
export class ServerAdvisors {
   ...
   * @param callback The callback
   */
  listByServer(resourceGroupName: string, serverName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.Advisor[]>): void;
  listByServer(resourceGroupName: string, serverName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.Advisor[]>, callback?: msRest.ServiceCallback<Models.Advisor[]>): Promise<Models.ServerAdvisorsListByServerResponse> {
