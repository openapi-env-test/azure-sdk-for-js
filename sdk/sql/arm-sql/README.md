...
#### nodejs - client creation and listByServer databases as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.databases.listByServer(resourceGroupName, serverName).then((result) => {
...
#### browser - Authentication, client creation and listByServer databases as an example written in JavaScript.
