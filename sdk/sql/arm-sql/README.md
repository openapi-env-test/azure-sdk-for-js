...
#### nodejs - client creation and listByDatabase databaseAdvisors as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.databaseAdvisors.listByDatabase(resourceGroupName, serverName, databaseName).then((result) => {
...
#### browser - Authentication, client creation and listByDatabase databaseAdvisors as an example written in JavaScript.
