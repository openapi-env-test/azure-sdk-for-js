...
#### nodejs - client creation and get extendedDatabaseBlobAuditingPolicies as an example written in TypeScript.
...
msRestNodeAuth.interactiveLogin().then((creds) => {
  ...
  client.extendedDatabaseBlobAuditingPolicies.get(resourceGroupName, serverName, databaseName).then((result) => {
...
#### browser - Authentication, client creation and get extendedDatabaseBlobAuditingPolicies as an example written in JavaScript.
