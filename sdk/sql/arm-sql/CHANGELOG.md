...
**Features**
  ...
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter typePropertiesType
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter currentRestoredSizeMB
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter currentRestorePlanSizeMB
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter currentBackupType
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter numberOfFilesQueued
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter numberOfFilesSkipped
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter numberOfFilesRestoring
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter numberOfFilesRestored
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter numberOfFilesUnrestorable
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter fullBackupSets
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter diffBackupSets
  - Type Alias ManagedDatabaseRestoreDetailsResult has a new parameter logBackupSets
