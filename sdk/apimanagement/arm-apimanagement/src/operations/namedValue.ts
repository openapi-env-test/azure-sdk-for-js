...
export class NamedValue {
   ...
   * @param namedValueId Identifier of the NamedValue.
   * @param [options] The optional parameters
   * @returns Promise<Models.NamedValueRefreshSecretResponse>
   */
  refreshSecret(resourceGroupName: string, serviceName: string, namedValueId: string, options?: msRest.RequestOptionsBase): Promise<Models.NamedValueRefreshSecretResponse> {
    return this.beginRefreshSecret(resourceGroupName,serviceName,namedValueId,options)
      .then(lroPoller => lroPoller.pollUntilFinished()) as Promise<Models.NamedValueRefreshSecretResponse>;
  }
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginRefreshSecret(resourceGroupName: string, serviceName: string, namedValueId: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        resourceGroupName,
        serviceName,
      ...
      beginRefreshSecretOperationSpec,
      options);
  }
   ...
   */
  listByServiceNext(nextPageLink: string, options?: Models.NamedValueListByServiceNextOptionalParams): Promise<Models.NamedValueListByServiceNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listByServiceNext(nextPageLink: string, options: Models.NamedValueListByServiceNextOptionalParams, callback: msRest.ServiceCallback<Models.NamedValueCollection>): void;
  listByServiceNext(nextPageLink: string, options?: Models.NamedValueListByServiceNextOptionalParams | msRest.ServiceCallback<Models.NamedValueCollection>, callback?: msRest.ServiceCallback<Models.NamedValueCollection>): Promise<Models.NamedValueListByServiceNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
...
const beginRefreshSecretOperationSpec: msRest.OperationSpec = {
  httpMethod: "POST",
