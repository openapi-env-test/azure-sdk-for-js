...
import { WorkspaceApiVersionSet } from "../operationsInterfaces";
...
/** Class containing WorkspaceApiVersionSet operations. */
export class WorkspaceApiVersionSetImpl implements WorkspaceApiVersionSet {
  private readonly client: ApiManagementClient;

  /**
   * Initialize a new instance of the class WorkspaceApiVersionSet class.
  ...
  private async *listByServicePagingPage(
    ...
    let result: WorkspaceApiVersionSetListByServiceResponse;
  ...
  private _listByService(
    ...
    workspaceId: string,
    options?: WorkspaceApiVersionSetListByServiceOptionalParams,
  ): Promise<WorkspaceApiVersionSetListByServiceResponse> {
  ...
  getEntityTag(
    ...
    return this.client.sendOperationRequest(
      { resourceGroupName, serviceName, workspaceId, versionSetId, options },
  ...
  ): Promise<WorkspaceApiVersionSetListByServiceNextResponse> {
    return this.client.sendOperationRequest(
...
const listByServiceOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/workspaces/{workspaceId}/apiVersionSets",
  httpMethod: "GET",
  responses: {
    200: {
...
const getEntityTagOperationSpec: coreClient.OperationSpec = {
  path: "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/workspaces/{workspaceId}/apiVersionSets/{versionSetId}",
  httpMethod: "HEAD",
  responses: {
    200: {
      headersMapper: Mappers.WorkspaceApiVersionSetGetEntityTagHeaders,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
...
const updateOperationSpec: coreClient.OperationSpec = {
  ...
  responses: {
    200: {
      bodyMapper: Mappers.ApiVersionSetContract,
      headersMapper: Mappers.WorkspaceApiVersionSetUpdateHeaders,
    },
    default: {
      bodyMapper: Mappers.ErrorResponse,
    },
