...
export const ApiManagementServiceIdentityUserAssignedIdentitiesValue: msRest.CompositeMapper = {
  serializedName: "ApiManagementServiceIdentity_userAssignedIdentitiesValue",
  type: {
    name: "Composite",
    className: "ApiManagementServiceIdentityUserAssignedIdentitiesValue",
    modelProperties: {
      principalId: {
        readOnly: true,
...
export const OpenidConnectProviderCreateContract: msRest.CompositeMapper = {
  serializedName: "OpenidConnectProviderCreateContract",
  type: {
    name: "Composite",
    className: "OpenidConnectProviderCreateContract",
    modelProperties: {
      ...Resource.type.modelProperties,
      displayName: {
        required: true,
