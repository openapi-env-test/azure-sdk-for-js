...
/** Defines headers for Certificate_entityTag operation. */
...
/** Optional parameters. */
export interface CertificateEntityTagOptionalParams
  extends coreClient.OperationOptions {}

/** Contains response data for the entityTag operation. */
