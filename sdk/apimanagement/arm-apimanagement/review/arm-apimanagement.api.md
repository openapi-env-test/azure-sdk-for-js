...
export interface Certificate {
    ...
    entityTag(resourceGroupName: string, serviceName: string, certificateId: string, options?: CertificateEntityTagOptionalParams): Promise<CertificateEntityTagResponse>;
...
// @public
export interface CertificateEntityTagHeaders {
    eTag?: string;
}

// @public
export interface CertificateEntityTagOptionalParams extends coreClient.OperationOptions {
}

// @public
export type CertificateEntityTagResponse = CertificateEntityTagHeaders;
