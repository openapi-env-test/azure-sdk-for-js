## API Report File for "@azure-rest/iot-device-update-demo"
...
export interface DeviceManagementStopDeploymentAAA {
    post(options?: DeviceManagementStopDeploymentAAAParameters): StreamableMethod<DeviceManagementStopDeploymentAAA200Response | DeviceManagementStopDeploymentAAAdefaultResponse>;
}
...
export interface Routes {
    ...
    (path: "/deviceUpdate/{instanceId}/management/groups/{groupId}/deviceClassSubgroups/{deviceClassId}/deployments/{deploymentId}:cancel", instanceId: string, groupId: string, deviceClassId: string, deploymentId: string): DeviceManagementStopDeploymentAAA;
