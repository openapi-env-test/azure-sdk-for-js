...
export class Apps {
   ...
   */
  createOrUpdate(appResource: Models.AppResource, resourceGroupName: string, serviceName: string, appName: string, options?: msRest.RequestOptionsBase): Promise<Models.AppsCreateOrUpdateResponse> {
    return this.beginCreateOrUpdate(appResource,resourceGroupName,serviceName,appName,options)
   ...
   * @param callback The callback
   */
  deleteMethod(resourceGroupName: string, serviceName: string, appName: string, callback: msRest.ServiceCallback<void>): void;
  /**
   * @param resourceGroupName The name of the resource group that contains the resource. You can
   * obtain this value from the Azure Resource Manager API or the portal.
   * @param serviceName The name of the Service resource.
   ...
   * @param callback The callback
   */
  deleteMethod(resourceGroupName: string, serviceName: string, appName: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<void>): void;
  deleteMethod(resourceGroupName: string, serviceName: string, appName: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<void>, callback?: msRest.ServiceCallback<void>): Promise<msRest.RestResponse> {
    return this.client.sendOperationRequest(
      {
        resourceGroupName,
        serviceName,
   ...
   */
  update(appResource: Models.AppResource, resourceGroupName: string, serviceName: string, appName: string, options?: Models.AppsUpdateOptionalParams): Promise<Models.AppsUpdateResponse> {
    return this.beginUpdate(appResource,resourceGroupName,serviceName,appName,options)
   ...
   */
  beginCreateOrUpdate(appResource: Models.AppResource, resourceGroupName: string, serviceName: string, appName: string, options?: msRest.RequestOptionsBase): Promise<msRestAzure.LROPoller> {
   ...
   * @returns Promise<msRestAzure.LROPoller>
   */
  beginUpdate(appResource: Models.AppResource, resourceGroupName: string, serviceName: string, appName: string, options?: Models.AppsBeginUpdateOptionalParams): Promise<msRestAzure.LROPoller> {
    return this.client.sendLRORequest(
      {
        appResource,
        resourceGroupName,
...
const beginUpdateOperationSpec: msRest.OperationSpec = {
  ...
  headerParameters: [
    Parameters.xMsIdentityUrl,
    Parameters.xMsIdentityPrincipalId,
    Parameters.xMsHomeTenantId,
