...
export class DataPolicyManifests {
   ...
   */
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase): Promise<Models.DataPolicyManifestsListNextResponse>;
  /**
   * @param nextPageLink The NextLink from the previous successful call to List operation.
   * @param callback The callback
   */
   ...
   * @param callback The callback
   */
  listNext(nextPageLink: string, options: msRest.RequestOptionsBase, callback: msRest.ServiceCallback<Models.DataPolicyManifestListResult>): void;
  listNext(nextPageLink: string, options?: msRest.RequestOptionsBase | msRest.ServiceCallback<Models.DataPolicyManifestListResult>, callback?: msRest.ServiceCallback<Models.DataPolicyManifestListResult>): Promise<Models.DataPolicyManifestsListNextResponse> {
    return this.client.sendOperationRequest(
      {
        nextPageLink,
        options
