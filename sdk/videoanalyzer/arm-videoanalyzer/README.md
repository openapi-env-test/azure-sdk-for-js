...
[Source code](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/videoanalyzer/arm-videoanalyzer) |
...
const client = new VideoAnalyzer("<endpoint>", new DefaultAzureCredential());
```
